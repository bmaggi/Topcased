...
public class RichTextImages {
	...
	public static final String IMG_PATH_INSERT_TABLE_ROW = ETOOL16 + "InsertTableRow.png"; //$NON-NLS-1$
    public static final String IMG_PATH_DELETE_TABLE_ROW = ETOOL16 + "DeleteTableRow.png"; //$NON-NLS-1$
    public static final String IMG_PATH_INSERT_TABLE_COL = ETOOL16 + "InsertTableCol.png"; //$NON-NLS-1$
    public static final String IMG_PATH_DELETE_TABLE_COL = ETOOL16 + "DeleteTableCol.png"; //$NON-NLS-1$
	...
	public static final Image IMG_INSERT_TABLE_ROW = richTextPlugin
            .getSharedImage(IMG_PATH_INSERT_TABLE_ROW);

    public static final Image IMG_DELETE_TABLE_ROW = richTextPlugin
            .getSharedImage(IMG_PATH_DELETE_TABLE_ROW);

    public static final Image IMG_INSERT_TABLE_COL = richTextPlugin
            .getSharedImage(IMG_PATH_INSERT_TABLE_COL);

    public static final Image IMG_DELETE_TABLE_COL = richTextPlugin
            .getSharedImage(IMG_PATH_DELETE_TABLE_COL);
	...
	public static final Image IMG_TEXTCOLOR = richTextPlugin
			.getSharedImage(IMG_PATH_TEXTCOLOR);
    ...
    public static final ImageDescriptor IMG_DESC_INSERT_TABLE_ROW = richTextPlugin
            .getImageDescriptor(IMG_PATH_INSERT_TABLE_ROW);

    public static final ImageDescriptor IMG_DESC_DELETE_TABLE_ROW = richTextPlugin
            .getImageDescriptor(IMG_PATH_DELETE_TABLE_ROW);

    public static final ImageDescriptor IMG_DESC_INSERT_TABLE_COL = richTextPlugin
            .getImageDescriptor(IMG_PATH_INSERT_TABLE_COL);

    public static final ImageDescriptor IMG_DESC_DELETE_TABLE_COL = richTextPlugin
            .getImageDescriptor(IMG_PATH_DELETE_TABLE_COL);
