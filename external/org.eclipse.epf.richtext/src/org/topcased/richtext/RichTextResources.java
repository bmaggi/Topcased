...
public final class RichTextResources extends NLS {
    ...
    public static String insertTableRowAction_toolTipText;
    public static String deleteTableRowAction_toolTipText;
    public static String insertTableColAction_toolTipText;
    public static String deleteTableColAction_toolTipText;
	...
	public static String insertTableRow_title;
	public static String insertTableRow_text;
	public static String deleteTableRow_title;
	public static String deleteTableRow_text;
	public static String insertTableColumn_title;
	public static String insertTableColumn_text;
	public static String deleteTableColumn_title;
	public static String deleteTableColumn_text;
