...
/**
 * Abstract implementation of a way to open the diagrams model contained in an model archive. By default, the diagrams model name is the same as the archive file.
 * 
 * @author David Sciamma
 */
public abstract class AbstractDiagramRedirector extends AbstractRedirector {
	...
	protected IFile getFileToOpen(IFile rasFile) 
	{
		...
		filePath = filePath.addFileExtension(getDomainFileExtension() + "di");
