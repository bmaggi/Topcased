...
/**
 * Handler removing the <b>org.topcased.core.topcasednature</b> to the current workspace project.<br>
 * 
 ...
 */
public class RemoveTopcasedNature extends AbstractHandler
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        try
        {
            ...
            {
                if (!TopcasedNature.TOPCASED_NATURE_ID.equals(natureIds[i])) 
                {
