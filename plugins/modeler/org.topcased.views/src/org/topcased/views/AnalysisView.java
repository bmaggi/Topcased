 ...
 *
 * $Id: AnalysisView.java,v 1.2 2012/07/26 05:38:10 gaufille Exp $
 **********************************************************************/
...
import org.topcased.views.actions.RefreshAction;
import org.topcased.views.actions.ToggleSynchronizeAction;
...
public abstract class AnalysisView extends ViewPart implements ISelectionListener
{
     ...
     * 
     * @param obj the EObject that must be analyzed
     */
     ...
     * 
     * @param synchro the new synchronization state
     */
     ...
     * 
     * @param actionBars the view action bars
     */
     ...
     * 
     * @param toolBar the view toolbar
     */
     ...
     * 
     * @param object the analyzed object
     */
