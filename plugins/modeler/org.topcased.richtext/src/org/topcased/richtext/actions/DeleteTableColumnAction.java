...
public class DeleteTableColumnAction extends RichTextAction {
	...
	public DeleteTableColumnAction(IRichText richText) {
        ...
        setImageDescriptor(RichTextImages.IMG_DESC_DELETE_TABLE_COL);
        setToolTipText(RichTextResources.deleteTableColAction_toolTipText);
	}
	...
	public void execute(IRichText richText) {
		if (richText != null) {
            ...
            InputDialog dialog = new InputDialog(parent, RichTextResources.deleteTableColumn_title, RichTextResources.deleteTableColumn_text, "0", new NumberValidator()); //$NON-NLS-1$
			if (dialog.open() == Window.OK) {
				richText.executeCommand(RichTextCommand.DELETE_TABLE_COL, dialog.getValue());
			}
		}
	}
