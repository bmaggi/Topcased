...
/**
 * The BackgroundColor section on the graphics tab.
 * 
 * Creation 31 mars 2006
 * 
 * @author Jacques LESCOT
 */
public class BackgroundColorPropertySection extends AbstractGraphicPropertySection
{
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage)
    {
        ...
        CLabel colorLabel = getWidgetFactory().createCLabel(composite, "Background Color:");
    ...
    protected void handleColorChanged()
    {
        ...
        if (newColor != null)
        {
            ...
            {
                ChangeDiagramElementPropertyCommand command = new ChangeDiagramElementPropertyCommand(getDiagElt(), ModelerPropertyConstants.BACKGROUND_COLOR, StringConverter.asString(newColor));
            ...
            else
            {
                ...
                {
                    ChangeDiagramElementPropertyCommand command = new ChangeDiagramElementPropertyCommand(nextObject, ModelerPropertyConstants.BACKGROUND_COLOR, StringConverter.asString(colorSelector.getColorValue()));
    ...
    public void refresh()
    {
        ...
        if (getSelectedEditPart() != null && getSelectedEditPart() instanceof AbstractGraphicalEditPart)
        {
        	...
        	{
        		colorSelector.setColorValue(((AbstractGraphicalEditPart) getSelectedEditPart()).getFigure().getBackgroundColor().getRGB());
    		}
        }
    }
    ...
    protected void handleModelChanged(Notification msg)
    {
        ...
        if (notifier instanceof Property && ModelerPropertyConstants.BACKGROUND_COLOR.equals(((Property) notifier).getKey()))
        {
               refresh();
        }
    }
