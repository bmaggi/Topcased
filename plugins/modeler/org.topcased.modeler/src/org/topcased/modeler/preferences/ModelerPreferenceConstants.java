...
public class ModelerPreferenceConstants
{
    ...
    public static final String PREFERENCE_TODO_NOTE_BUILDER = "enableTodoNoteBuilder" ;
    
    /** The constant for the note preference page */ 
    public static final String NOTE_DEFAULT_BACKGROUND_COLOR = "Note Default Background Color";
    
    public static final String NOTE_DEFAULT_FONT="Note Default Font";
    
    public static final String NOTE_DEFAULT_FOREGROUND_COLOR="Note Default Foreground Color";
    
    public static final String PREFERENCE_TEXT_FOR_TODO="textForTodo";
