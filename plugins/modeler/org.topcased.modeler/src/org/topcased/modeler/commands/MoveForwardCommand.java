...
/**
 * A class defining a command to move forward a graph element<br/> Creation :
 * 11 oct. 2005
 * 
 * @author <a href="mailto:thomas.friol@anyware-tech.com">Thomas FRIOL</a>
 */
public class MoveForwardCommand extends AbstractMoveCommand
{
    public MoveForwardCommand(GraphElement element)
    {
        super(element);
