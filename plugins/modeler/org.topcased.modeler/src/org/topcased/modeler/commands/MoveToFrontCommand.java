...
/**
 * A class defining a command to move to front a graph element<br/> Creation :
 * 11 oct. 2005
 * 
 * @author <a href="mailto:thomas.friol@anyware-tech.com">Thomas FRIOL</a>
 */
public class MoveToFrontCommand extends AbstractMoveCommand
{
    public MoveToFrontCommand(GraphElement element)
    {
        super(element);
