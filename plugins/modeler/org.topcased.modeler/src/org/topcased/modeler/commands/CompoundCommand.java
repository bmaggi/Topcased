...
import org.topcased.modeler.actions.GenericTransformer;
 ...
 * @deprecated this kind of command would hardly work in a transactional context (may be used very occasionally in a
 *             command execution only). A better approach is to build a {@link CommandAdapter} with a
 *             {@link EMFtoGEFCommandWrapper}, to create and execute necessary commands in the
 *             {@link CommandAdapter#execute()} method and to store them in a
 *             {@link org.eclipse.gef.commands.CompoundCommand} which will be used to {@link CommandAdapter#undo()} or
 *             {@link CommandAdapter#redo()} the command. See ImporterCommand in
 *             {@link GenericTransformer#transform(org.eclipse.emf.ecore.EClass)} or commands in
 *             {@link Importer#run(org.eclipse.core.runtime.IProgressMonitor)} for examples.
 */
