 ...
 *
 */
public abstract class ReconnectTargetToSourceCommand extends ReconnectNodeToNodeCommand
{
     ...
     * @param direction
     */
    public ReconnectTargetToSourceCommand(ConnectionEditPart connection, String featureName, int direction)
    {
    ...
    /**
     * @see org.topcased.modeler.commands.ReconnectNodeToNodeCommand#redoModel()
     */
    protected void redoModel()
    {
        ...
        if (getReconnectionEndType() == SOURCE)
        {
            doDirectReference(toUpdate, newReference, oldReference);
        }
        else if (getReconnectionEndType() == TARGET)
        {
    ...
    /**
     * @see org.topcased.modeler.commands.ReconnectNodeToNodeCommand#undoModel()
     */
