...
/**
 * Workbench-level composite that combines a CheckboxTreeViewer and CheckboxListViewer. All viewer selection-driven
 * interactions are handled within this object
 */
public class CheckboxTreeAndListGroup extends EventManager implements ICheckStateListener, ISelectionChangedListener, ITreeViewerListener
{
    ...
    private List<Object> expandedTreeNodes = new ArrayList<Object>();

    private Map<Object, List<Object>> checkedStateStore = new HashMap<Object, List<Object>>(9);

    private List<Object> whiteCheckedTreeItems = new ArrayList<Object>();
    ...
    /**
     * Create an instance of this class. Use this constructor if you wish to specify the width and/or height of the
     * combined widget (to only hardcode one of the sizing dimensions, specify the other dimension's value as -1)
     * 
     * @param parent
     * @param rootObject
     ...
     * @param height
     */
    public CheckboxTreeAndListGroup(Composite parent, Object rootObject, ITreeContentProvider treeContentProvider, ILabelProvider treeLabelProvider, IStructuredContentProvider listContentProvider,
    ...
    /**
     * Add the receiver and all of it's ancestors to the checkedStateStore if they are not already there.
     */
    ...
    /**
     * Return a boolean indicating whether all list elements associated with the passed tree element are currently
     * checked
     * 
     * @return boolean
     * @param treeElement java.lang.Object
    ...
    {
        List<Object> checkedElements = (List<Object>) checkedStateStore.get(treeElement);
    ...
    /**
     * Iterate through the passed elements which are being realized for the first time and check each one in the tree
    ...
    /**
     * Returns a boolean indicating whether the passed tree element should be at LEAST gray-checked. Note that this
     * method does not consider whether it should be white-checked, so a specified tree item which should be
     * white-checked will result in a <code>true</code> answer from this method. To determine whether a tree item should
     * be white-checked use method #determineShouldBeWhiteChecked(Object).
     * 
     * @param treeElement java.lang.Object
     * @return boolean
    ...
    protected boolean determineShouldBeAtLeastGrayChecked(Object treeElement)
    {
        ...
        List<Object> checked = (List<Object>) checkedStateStore.get(treeElement);
    ...
    public Iterator<Object> getAllCheckedListItems()
    {
        ...
        {
            Iterator<Object> currentCollection = ((List<Object>) listCollectionsEnum.next()).iterator();
    ...
    /**
     * Set the initial checked state of the passed element to true, as well as to all of its children and associated
     * list elements
     * 
    ...
    /**
     * Callback that's invoked when the checked status of an item in the list is changed by the user. Do not try and
     * update the hierarchy if we are building the initial list.
     */
    protected void listItemChecked(Object listElement, boolean state, boolean updatingFromSelection)
    {
        List<Object> checkedListItems = (List<Object>) checkedStateStore.get(currentTreeSelection);
        ...
        if (state)
        {
            if (checkedListItems == null)
            {
                ...
                checkedListItems = (List<Object>) checkedStateStore.get(currentTreeSelection);
            }
    ...
    /**
     * Set the contents of the list viewer based upon the specified selected tree element. This also includes checking
     * the appropriate list items.
     * 
     * @param treeElement java.lang.Object
     */
    protected void populateListViewer(final Object treeElement)
    {
        ...
        List<Object> listItemsToCheck = (List<Object>) checkedStateStore.get(treeElement);
    ...
    /**
     * Select or deselect all of the elements in the tree depending on the value of the selection boolean. Be sure to
     * update the displayed files as well.
     * 
    ...
    /**
     * Set the checked state of the passed tree element appropriately, and do so recursively to all of its child tree
     * elements as well
     */
     ...
     * 
     * @param items Map with keys of Object (the tree element) and values of List (the selected list elements).
     */
        ...
        BusyIndicator.showWhile(treeViewer.getControl().getDisplay(), new Runnable()
        {
            public void run()
            {
                ...
                while (keyIterator.hasNext())
                {
                    ...
                    List<Object> selections = (List<Object>) items.get(key);
                ...
                while (keyIterator.hasNext())
                {
                    ...
                    if (currentTreeSelection != null && currentTreeSelection.equals(key))
                    {
                        ...
                        listViewer.setCheckedElements(((List<Object>) items.get(key)).toArray());
                    }
                }
            }
        });
