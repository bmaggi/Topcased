/*****************************************************************************
 * Copyright (c) 2005, 2008 AIRBUS FRANCE, 2012 AtoS.
 *
 ...
 *  Thibault Landre (Atos Origin) - add project scope to preference page
 *  Nicolas Peransin (AtoS) - Extract Todo preferences.
 *
 *****************************************************************************/
    ...
    implements IWorkbenchPreferencePage, IWorkbenchPropertyPage
{
    ...
    protected Control createContents(Composite parent)
    {
        ...
        createControlledGroup(parentComposite);
    ...
    protected void createDefaultGroup(Composite parent)
    {
        ...
        Group defaultGp = new Group(parent, SWT.NONE);
     ...
     * @param parent the parent Composite
     */
    protected void createControlledGroup(Composite parent)
    {
        // group for controlled elements
        Group group = new Group(parent, SWT.NONE);
        group.setLayout(new GridLayout(2, false));
        group.setLayoutData(new GridData(GridData.FILL_BOTH));
        group.setText(Messages.getString("ModelerPreferencePage.15")); //$NON-NLS-1$
        
        GridData gd2 = new GridData(GridData.FILL_HORIZONTAL);
        gd2.horizontalSpan = 2;
        useDifferentColorsForControlledElements = new Button(group, SWT.CHECK);
        useDifferentColorsForControlledElements.setText(Messages.getString("ModelerPreferencePage.16")); //$NON-NLS-1$
        useDifferentColorsForControlledElements.setLayoutData(gd2);

        colorForSameResource = new ColorFieldEditor(ModelerPreferenceConstants.PREFERENCE_COLOR_FOR_SAME_RESOURCE, Messages.getString("ModelerPreferencePage.17"), group); //$NON-NLS-1$
        colorForSameResource.setPreferenceStore(getPreferenceStore());
        colorForSameResource.fillIntoGrid(group, 2);
        // colorForDifferentResource.getColorSelector().getButton().setLayoutData(new GridData(SWT.FILL, SWT.NONE,
        // false, false));

        colorForDifferentResource = new ColorFieldEditor(ModelerPreferenceConstants.PREFERENCE_COLOR_FOR_DIFFERENT_RESOURCE, Messages.getString("ModelerPreferencePage.18"), group); //$NON-NLS-1$
        colorForDifferentResource.setPreferenceStore(getPreferenceStore());
        colorForDifferentResource.fillIntoGrid(group, 2);
        // colorForDifferentResource.getColorSelector().getButton().setLayoutData(new GridData(SWT.FILL, SWT.NONE,
        // false, false));

        controlledReadOnly = new Button(group, SWT.CHECK);
        ...
        gd2.horizontalSpan = 2;
        controlledReadOnly.setLayoutData(gd2);

        Composite c = new Composite(group, SWT.None);
        selectFilteredElements = new BooleanFieldEditor(ModelerPreferenceConstants.PREFERENCE_OUTLINE_SELECT_FILTERED_ELEMENTS, Messages.getString("ModelerPreferencePage.20"), c); //$NON-NLS-1$
        selectFilteredElements.setPreferenceStore(getPreferenceStore());
        gd2 = new GridData(GridData.FILL_HORIZONTAL);
        gd2.horizontalSpan = 2;
        c.setLayoutData(gd2);

        limitForElementSelection = new IntegerFieldEditor(ModelerPreferenceConstants.PREFERENCE_OUTLINE_LIMIT_FOR_SELECTION, Messages.getString("ModelerPreferencePage.21"), group); //$NON-NLS-1$
        limitForElementSelection.setPreferenceStore(getPreferenceStore());
        limitForElementSelection.setTextLimit(5);
        limitForElementSelection.fillIntoGrid(group, 2);
...
//        limitForElementSelection.getTextControl(controlledEltGroup).setLayoutData(new GridData(SWT.FILL, SWT.NONE, true, false));
        ...
        limitForHistorik = new IntegerFieldEditor(ModelerPreferenceConstants.PREFERENCE_OUTLINE_LIMIT_FOR_HISTORIK, Messages.getString("ModelerPreferencePage.22"), group); //$NON-NLS-1$
        limitForHistorik.setPreferenceStore(getPreferenceStore());
        limitForHistorik.setTextLimit(5);
        limitForHistorik.fillIntoGrid(group, 2);
...
//        limitForHistorik.getTextControl(controlledEltGroup).setLayoutData(new GridData(SWT.FILL, SWT.NONE, true, false));
        ...
        displayVirtualContainers = new Button(group, SWT.CHECK);
        displayVirtualContainers.setText(Messages.getString("ModelerPreferencePage.23")); //$NON-NLS-1$
        gd2 = new GridData(GridData.FILL_HORIZONTAL);
        gd2.horizontalSpan = 2;
        displayVirtualContainers.setLayoutData(gd2);

        Composite c2 = new Composite(group, SWT.None);
        displayHiddenEannotations = new BooleanFieldEditor(ModelerPreferenceConstants.PREFERENCE_DISPLAY_HIDDEN_EANNOTATION, Messages.getString("ModelerPreferencePage.29"), c2); //$NON-NLS-1$
