 ...
 */
public class ChangeForegroundColorAction extends WorkbenchPartAction implements ISelectionChangedListener
{
     ...
     */
    public ChangeForegroundColorAction(IWorkbenchPart part)
    {
        super(part);
    }

    /**
     * Open a dialog to select the new Foreground Color
     * 
    ...
    public void run()
    {
        ...
        // element
        colorDialog.setRGB(((AbstractGraphicalEditPart) editParts.get(0)).getFigure().getForegroundColor().getRGB());
        ...
        if (newColor != null)
        {
            ...
            Request request = new Request(ModelerRequestConstants.REQ_CHANGE_FOREGROUND_COLOR);
            Map params = new HashMap();
            params.put(ModelerPropertyConstants.FOREGROUND_COLOR, newColor);
    ...
    protected boolean calculateEnabled()
    {
        ...
        // construct the ChangeForegroundColorRequest
        Request request = new Request(ModelerRequestConstants.REQ_CHANGE_FOREGROUND_COLOR);
    ...
    /**
     * Initializes the change Foreground Color action
     * 
     * @see org.eclipse.gef.ui.actions.WorkbenchPartAction#init()
     */
    protected void init()
    {
        setId(ModelerActionConstants.CHANGE_FOREGROUND_COLOR);
        setText("Change Foreground Color");
        setImageDescriptor(ModelerImageRegistry.getImageDescriptor("FGCOLOR"));
    }
