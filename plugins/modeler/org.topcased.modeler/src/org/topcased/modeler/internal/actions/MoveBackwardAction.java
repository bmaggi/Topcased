...
/**
 * A class defining an action to move backward a graph element.<br/> Creation :
 * 11 oct. 2005
 * 
 * @author <a href="mailto:thomas.friol@anyware-tech.com">Thomas FRIOL</a>
 */
public class MoveBackwardAction extends WorkbenchPartAction implements ISelectionChangedListener
{
    AbstractGraphicalEditPart graphElement;

    public MoveBackwardAction(IWorkbenchPart part)
    {
        super(part);
        setActionDefinitionId("org.topcased.modeler.moveBackward");
    ...
    protected boolean calculateEnabled()
    {
        ...
        Request request = new Request(ModelerRequestConstants.REQ_MOVE_BACKWARD);
    ...
    protected void init()
    {
        setId(ModelerActionConstants.MOVE_BACKWARD);
        setText("Move backward");
        setImageDescriptor(ModelerImageRegistry.getImageDescriptor("MOVE_BACKWARD"));
    }
