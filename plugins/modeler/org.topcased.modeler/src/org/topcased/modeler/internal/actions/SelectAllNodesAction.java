...
/**
 * This class represents the action to select all nodes displayed in a diagram.
 */
public class SelectAllNodesAction extends WorkbenchPartAction implements ISelectionChangedListener
{
	...
	/**
	 * Instantiates a new select all nodes action.
	 * 
	 * @param part the part
	 */
	public SelectAllNodesAction(IWorkbenchPart part) 
	{
		 super(part);
		 this.part = part;
	}
    ...
    protected void init()
    {
        setId(ModelerActionConstants.SELECT_ALL_NODES);
        setText("Select All Nodes");
        setImageDescriptor(ModelerImageRegistry.getImageDescriptor("SELECT_ALL_NODES"));
    }
     ...
     * This method add all the children edit part nodes of the given parent editPart to the set, except instance of DiagramEditPart.
     * 
