...
/**
 * A drag tracker for {@link org.topcased.modeler.di.model.EdgeObjectUV}.<br>
 * Creation : 3 nov. 2005
 * 
 * @author <a href="mailto:thomas@anyware-tech.com">Thomas Friol</a>
 */
public class EdgeObjectUVDragTracker extends EdgeObjectDragTracker
{
    public EdgeObjectUVDragTracker(GraphicalEditPart editPart, EdgeObjectUV edgeObject)
    {
    ...
    {
        return ModelerRequestConstants.REQ_CHANGE_EO_UV;
    }
}
