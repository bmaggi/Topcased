...
public class GraphNodeEditPart extends BaseEditPart implements NodeEditPart
{
    ...
    protected Font getDefaultFont()
    {
        if (getPreferenceDefaultFont() != null)
        {
        	...
        	Font font = getPreferenceDefaultFont();
        	FontData fontData = font.getFontData()[0];
        	 return Utils.getFont(fontData);
        }
        else if (getNodeGraphConf() != null)
        {
    ...
    /**
     * A proxy to method getDefaultFont in order to change the visibility of the method without refactoring all subclasses. 
     * @return font
     */
    public Font getEditPartDefaultFont()
    {
    ...
    protected Font getStyledFont(int style)
    {
        ...
        String b = asString.replace(";", "");
        if (!JFaceResources.getFontRegistry().hasValueFor(b))
        {
            JFaceResources.getFontRegistry().put(b, fData);
        }
        return JFaceResources.getFontRegistry().get(b);
    }
