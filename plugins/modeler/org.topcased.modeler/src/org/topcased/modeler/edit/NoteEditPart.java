...
public class NoteEditPart extends GraphNodeEditPart
{
    ...
    {
        String backgroundColor = getPreferenceStore().getString(ModelerPreferenceConstants.NOTE_DEFAULT_BACKGROUND_COLOR);
    ...
    {
        String foregroundColor = getPreferenceStore().getString(ModelerPreferenceConstants.NOTE_DEFAULT_FOREGROUND_COLOR);
    ...
    {
        String preferenceFont = getPreferenceStore().getString(ModelerPreferenceConstants.NOTE_DEFAULT_FONT);
    ...
    {
        return Utils.getPreferenceStoreAccordingToCurrentIFile();
    }
