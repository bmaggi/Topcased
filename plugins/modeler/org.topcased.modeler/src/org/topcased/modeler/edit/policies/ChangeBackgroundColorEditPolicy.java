 ...
 */
public class ChangeBackgroundColorEditPolicy extends AbstractEditPolicy
{
    /**
    ...
    {
        if (ModelerRequestConstants.REQ_CHANGE_BACKGROUND_COLOR.equals(request.getType()))
        {
            GraphElement elt = (GraphElement) getHost().getModel();
            RGB newColor = (RGB) request.getExtendedData().get(ModelerPropertyConstants.BACKGROUND_COLOR);
            if (elt != null && newColor != null)
            {
                ...
                ChangeDiagramElementPropertyCommand command = new ChangeDiagramElementPropertyCommand(elt,
                        ModelerPropertyConstants.BACKGROUND_COLOR, StringConverter.asString(newColor));
                return command;
            }
        }
        return null;
    ...
    {
        return ModelerRequestConstants.REQ_CHANGE_BACKGROUND_COLOR.equals(req.getType());
    }
