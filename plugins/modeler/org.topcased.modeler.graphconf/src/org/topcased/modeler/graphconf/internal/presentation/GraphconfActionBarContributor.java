 ...
 * </copyright>
 *
 * $Id: GraphconfActionBarContributor.java,v 1.3 2006/12/18 15:21:43 jako Exp $
 */
...
/**
 * This is the action bar contributor for the Graphconf model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class GraphconfActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(GraphConfPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        public void run()
        {
            try
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(GraphConfPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
     ...
     * @generated
     */
    public GraphconfActionBarContributor()
    {
    ...
    {
        toolBarManager.add(new Separator("graphconf-settings"));
        toolBarManager.add(new Separator("graphconf-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(GraphConfPlugin.INSTANCE.getString("_UI_GraphconfEditor_menu"), "org.topcased.modeler.graphconfMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(GraphConfPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(GraphConfPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(GraphConfPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(GraphConfPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
