...
public class EMFGraphNodeEditPart extends GraphNodeEditPart implements IModelElementEditPart
{
    ...
    protected void refreshHeaderLabel()
    {
        ...
        {
            ILabelFeatureProvider featureProvider = (ILabelFeatureProvider) ((MixedEditDomain) getViewer().getEditDomain()).getAdapterFactory().adapt(getEObject(), ILabelFeatureProvider.class);
