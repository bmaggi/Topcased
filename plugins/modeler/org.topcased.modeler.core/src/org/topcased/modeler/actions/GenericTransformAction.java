...
public class GenericTransformAction extends CompoundContributionItem
{
            ...
            for (EClassifier c : allEClassifiers)
            {
                if (c instanceof EClass)
                {
                            ...
                            && !eclass.isAbstract())
                    {
                        ...
                        item.addSelectionListener(new GenericSelectionListener(eclass));
    ...
    private class GenericSelectionListener implements SelectionListener
    {
        ...
        public GenericSelectionListener(EClass c)
        {
            this.eclass = c;
        }
        ...
        public void widgetSelected(SelectionEvent e)
        {
            ...
            if (result == SWT.YES || result == Window.OK)
            {
                ...
                if (GenericTransformAction.this.selection != null)
                {
                    transformer = new GenericTransformer(GenericTransformAction.this.selection);
                }
                else
                {
                    transformer = new GenericTransformer(GenericTransformAction.this.selectionEObject);
                }
