...
/**
 * Check that the user has confirmed the graphical deletion, either through a popup or through the corresponding
 * preference.
 * 
 * @author vhemery
 */
public class DeleteGraphConfirmationChecker implements ActionConditionChecker
{
    /**
    ...
    {
        ConfirmationDialog dialog = new ConfirmationDialog(ModelerPlugin.getActiveWorkbenchShell(), Messages.getString("DeleteGraphElementAction.CmdLabel"),
                Messages.getString("DeleteGraphElementAction.ConfirmMessage"), modeler.getPreferenceStore(), ModelerPreferenceConstants.DELETE_ACTION_CONFIRM);
