...
public class EObjectInheritanceCopyCommand extends CompoundCommand
{
    ...
    public EObjectInheritanceCopyCommand(EObject source, EClass target, AdapterFactoryEditingDomain adapterFactoryEditingDomain)
    {
    ...
    private class CustomSetCommand extends SetCommand
    {
        ...
        public CustomSetCommand(AdapterFactoryEditingDomain editingDomain, EObject theObjectWithCross, EStructuralFeature structuralFeature, EObject target)
        {
    ...
    private class CustomAddCommand extends AddCommand
    {
        ...
        public CustomAddCommand(AdapterFactoryEditingDomain editingDomain, EObject target, EStructuralFeature targetFeature, Collection<EObject> newList, EObject source, EStructuralFeature e)
        {
