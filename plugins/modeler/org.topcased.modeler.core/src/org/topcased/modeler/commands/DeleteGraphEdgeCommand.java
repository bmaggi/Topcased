...
class DeleteGraphEdgeCommand extends Command
{
    ...
    {
        return !TopcasedAdapterFactoryEditingDomain.isEObjectReadOnly(parent);
    }
    ...
    public void redo()
    {
        if (parent != null)
        {
            ...
            sourceConnector = (GraphConnector) anchors.get(0);
            targetConnector = (GraphConnector) anchors.get(1);
