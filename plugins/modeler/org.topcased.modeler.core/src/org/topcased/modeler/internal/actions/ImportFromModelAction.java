...
public class ImportFromModelAction extends CommandActionHandler
{
    ...
    public void run()
    {
        ...
        final EObject elementToImport = SelectResourceDialog.openElementSelection(root, validator, filters, false);
        ...
        if (eResource != null)
        {
            ...
            EObject semanticEltImported = copier.performSemanticCopy(eObject);
            ...
            if (diagramResource != null && !diagramResource.getContents().isEmpty())
            {
                ...
                {
                    Diagrams diagramsImported = copier.performViewsCopy(diagramsToImport);
                ...
                else
                {
                    ...
                    else if (innerDiagrams != null && !innerDiagrams.isEmpty())
                    {
                        ...
                        {
                            Diagrams diagramsImported = copier.performViewsCopy(childDiagramsToImport);
     ...
     * 
     * @param parentDiagrams a Diagrams from which search should be started. Should be a Diagrams from a "higher level" regarding the semantic element.
     * @param modelObject the semantic element to be compared with semantic element associated with Diagrams
     * @return a list of Diagrams that could be considered as children Diagrams when compared to the given semantic element
     */
