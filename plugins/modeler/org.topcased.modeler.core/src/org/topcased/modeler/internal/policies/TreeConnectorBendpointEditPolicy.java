 ...
 */
public class TreeConnectorBendpointEditPolicy extends ConnectorBendpointEditPolicy
{
            ...
            if (treeRouter != null)
            {
                ...
                while (li.hasNext())
                {
                    ...
                    if (!conn.equals(getConnection()))
                    {
                        ...
                        if (connectorEP != null)
                        {
                            GraphEdge edge = (GraphEdge) connectorEP.getModel();
                            Command cmd1 = getBendpointsChangedCommand(conn, edge);
                            if (cmd1 != null)
                            {
                                cmd = cmd.chain(cmd1);
                            }
