...
/**
 * A class defining an action to move to front a graph element.<br/> Creation :
 * 11 oct. 2005
 * 
 * @author <a href="mailto:thomas.friol@anyware-tech.com">Thomas FRIOL</a>
 */
public class MoveToFrontAction extends WorkbenchPartAction implements ISelectionChangedListener
{
    AbstractGraphicalEditPart graphElement;

    public MoveToFrontAction(IWorkbenchPart part)
    {
        super(part);
        setActionDefinitionId("org.topcased.modeler.moveToFront");
    ...
    protected boolean calculateEnabled()
    {
        ...
        Request request = new Request(ModelerRequestConstants.REQ_MOVE_TO_FRONT);
    ...
    protected void init()
    {
        setId(ModelerActionConstants.MOVE_TO_FRONT);
        setText("Move to front");
        setImageDescriptor(ModelerImageRegistry.getImageDescriptor("MOVE_TO_FRONT"));
    }
