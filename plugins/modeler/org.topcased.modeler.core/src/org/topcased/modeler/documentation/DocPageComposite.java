...
public abstract class DocPageComposite extends Composite implements CommandStackListener
{
    ...
    public DocPageComposite(Composite parent, int style, IEditingDomainProvider editingDomainProvider)
    {
        ...
        {
			/*
			 * An IllegalArgumentException has occurred because command stack is
			 * not yet available, since the input view has not been linked from
			 * the editing domain, hence it can not provide the command stack.
			 * This can occur when no editor is active. Do nothing.
			 */
        }
