 ...
 */
public class DocumentationFileGenerator extends AbstractFileGenerator
{
     ...
     */
    public DocumentationFileGenerator(IContainer outputContainer)
    {
        super("org::topcased::modeler::export::html::templates::DocumentationFile::file FOR graphElement", outputContainer, "graphElement");
    }
}
