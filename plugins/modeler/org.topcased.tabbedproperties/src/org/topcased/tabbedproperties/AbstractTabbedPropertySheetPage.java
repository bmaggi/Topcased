...
public class AbstractTabbedPropertySheetPage extends TabbedPropertySheetPage
{
    ...
    public static List< ? extends AdapterFactory> getPrincipalAdapterFactories()
    {
        ...
        // REV Remove the Reflective adapter, this causes bad issues in labels displayed in the advanced tab when the corresponding factory is not added to the list
//        factories.add(new ReflectiveItemProviderAdapterFactory());
    ...
    protected ComposedAdapterFactory createAdapterFactory()
    {
        ...
        //Modification to can use the mecanism of "Extensible Provider Factory" of GenModel
        ComposedAdapterFactory composedAdapterFactory = new ComposedAdapterFactory(ComposedAdapterFactory.Descriptor.Registry.INSTANCE);
        List<? extends AdapterFactory> adapterFactories = getAdapterFactories();
        for (Iterator<? extends AdapterFactory> iterator = adapterFactories.iterator(); iterator.hasNext();)
        {
            composedAdapterFactory.addAdapterFactory(iterator.next());
        }
    ...
    /**
     * <b>This method could be overridden to add specific factories before those. </b> <br>
     * 
