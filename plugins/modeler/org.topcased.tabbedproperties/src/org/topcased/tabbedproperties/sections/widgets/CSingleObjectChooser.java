 ...
 *
 * Contributors:
 *      David Sciamma (Anyware Technologies), Jacques Lescot (Anyware
...
public class CSingleObjectChooser extends Composite
{
    ...
    /**
     * If the text field is editable, replace the actual text with the content of the parameter. Does nothing when the
     * text field is not editable.
     * 
     * @param text the new string to put in the text field
     */
    ...
    /**
     * Set the advanced labelprovider that displays the objects
     * 
     * @param provider the LabelProvider
     */
