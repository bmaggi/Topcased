 ...
 * 
 * 
 * Copyright (c) 2007 TOPCASED consortium.
 *
 * Contributors:
 * 	<a href="mailto:thibault.landre@atosorigin.com">Thibault Landré</a>
 * 	
 *    
...
public class DirectoryChooser extends Composite
{
     ...
     */
    public DirectoryChooser(Composite parent, TabbedPropertySheetWidgetFactory factory, int style)
    {
        super(parent, style);
    ...
    private void handleChoose()
    {
        ...
        {
            String oldPath = getSelection();
            setSelection(directoryPath);
            handleDirectoryPathChange(directoryPath, oldPath);
        }
    }
     ...
     */
    private void handleDirectoryPathChange(String directoryPath, String oldPath)
    {
        if (directoryHasChanged(oldPath, directoryPath))
        {
    ...
    /**
     * Set the selection of the DirectoryChooser.
     * 
    ...
    public void setSelection(String selection, boolean updateField)
    {
        ...
        if (updateField)
        {
            ...
            {
                field.setSelection(selectedDirectory.length());
            }
        }
    }
    ...
    /**
     * Return true if newDirectoryPath and oldDirectoryPath are different.
     * 
     * @param oldDirectoryPath the old directory path
     * @param newDirectoryPath the new directory path
     * 
     * @return true, if directory has changed
     */
    private boolean directoryHasChanged(String oldDirectoryPath, String newDirectoryPath)
    {
        boolean change = true;

        if (oldDirectoryPath == null && newDirectoryPath == null || oldDirectoryPath != null && oldDirectoryPath.equals(newDirectoryPath))
        {
            change = false;
        }
