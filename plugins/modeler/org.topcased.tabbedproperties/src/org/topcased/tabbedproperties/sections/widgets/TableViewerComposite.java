...
public class TableViewerComposite extends Composite
{
    ...
    /**
     * InnerClass that acts as a proxy for the TableObjectManager providing content for the Table. It implements the
     * IEObjectModifyListener interface since it must register changeListeners with the TableObjectManager
     */
    ...
    /**
     * User may implement other buttons to be displayed at the right side of the table. This method must initialize a
     * list of Buttons.
     * 
     ...
     * 
     * When the given parameter is null, it will set a default label provider, in particular when the table viewer is
     * going to display multifeature Attributes. In order to display multifeature references, client may pass a
    ...
    /**
     * Modification will be taken in charge by the object manager. Client may specify an editing domain to consider
     * modifications
     * 
     * @param editingDomain Manages a self-contained set of interrelated EMF models and the {@link Command}s that modify
     *        them.
     */
    ...
    /**
     * Adds the element to the objectManager with the specified command.
     * 
     * @param newElement the new element
     * @param command the command
     */
    public void addElement(Object newElement, Command command)
    {
        if (objectManager != null)
        {
            objectManager.addElement(newElement, command);
        }
    }
    ...
    /**
     * This method is called each time a new item is selected in the Table. When client desire to do something when an
     * item is selected, this method must be overrided
     * 
