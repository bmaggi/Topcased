 ...
 * 
 * Contributors: Alfredo Serrano (Anyware Technologies) - initial API and implementation
 ****************************************************************************************/
...
/**
 * A Label Provider that formats the provided String text The text will be displayed like:
 * 
...
public class TabbedPropertiesLabelProvider extends AdapterFactoryLabelProvider
{
     ...
     * The returned string will have the StructuralFeature with a description of its EcoreClass and its model.
     * 
    ...
    public String getText(Object object)
    {
        ...
        {
            // When it is a EObject we will try to build a
            // user friendly label text
            resultText = (String) new GenModelLabelSwitch().doSwitch((EObject) object);
        }
