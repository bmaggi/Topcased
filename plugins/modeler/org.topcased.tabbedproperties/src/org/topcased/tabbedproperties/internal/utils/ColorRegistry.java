// ------------------------------------------------
// $Id: ColorRegistry.java,v 1.2 2007/03/08 10:19:37 alfredoserrano Exp $
...
/**
 * The color registry class helps client to color its sections.
 * 
 * This registry manages all the allocated colors and dispose its when the current display is disposed. <br>
 * <br>
 * creation : 8 oct. 2004
 * 
...
public final class ColorRegistry
{
    ...
    /**
     * Table of known colors, keyed by symbolic color name (key type: <code>String</code>, value type: <code>org.eclipse.swt.graphics.Color</code>.
     */
    ...
    /**
     * Returns the <code>color</code> associated with the given RGB object, or <code>null</code> if no such definition exists.
     * 
