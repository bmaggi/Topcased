...
public class TableObjectManager
{
    ...
    private final EObject inputEObject;
     ...
     * 
     * @param newElement the element to add
     * @param command another command to execute
     */
    public void addElement(Object newElement, Command command)
    {
        ...
        {
            cpcmd.append(AddCommand.create(editingDomain, inputEObject, feature, newElement));
        }
        editingDomain.getCommandStack().execute(cpcmd);
    }
    ...
    {
        Collection<EObject> choiceOfValues = TypeCacheAdapter.getExistingTypeCacheAdapter(inputEObject).getReachableObjectsOfType(inputEObject, feature.getEType());
