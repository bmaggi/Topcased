 ...
 * </copyright>
 *
 * $Id: EditorconfiguratorAdapterFactory.java,v 1.6 2007/04/18 12:54:45 jako Exp $
 */
 ...
 * @generated
 */
public class EditorconfiguratorAdapterFactory extends AdapterFactoryImpl
{
    /**
     ...
     * @generated
     */
    public EditorconfiguratorAdapterFactory()
    {
     ...
     * @generated
     */
    protected EditorconfiguratorSwitch<Adapter> modelSwitch = new EditorconfiguratorSwitch<Adapter>()
    {
        @Override
        ...
        @Override
        public Adapter caseEditorAction(EditorAction object)
        {
            return createEditorActionAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.topcased.modeler.editorconfigurator.EditorConfiguration <em>Editor Configuration</em>}'.
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.topcased.modeler.editorconfigurator.EditorAction <em>Editor Action</em>}'.
     * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful
     * to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createEditorActionAdapter()
    {
        return null;
    }
...
} // EditorconfiguratorAdapterFactory
