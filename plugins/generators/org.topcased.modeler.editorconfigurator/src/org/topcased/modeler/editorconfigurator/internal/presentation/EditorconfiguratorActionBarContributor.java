 ...
 * </copyright>
 *
 * $Id: EditorconfiguratorActionBarContributor.java,v 1.5 2007/04/18 12:54:47 jako Exp $
 */
...
/**
 * This is the action bar contributor for the Editorconfigurator model editor. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class EditorconfiguratorActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(EditorConfiguratorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        @Override
        public void run()
        {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(EditorConfiguratorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        @Override
     ...
     * @generated
     */
    public EditorconfiguratorActionBarContributor()
    {
    ...
    {
        toolBarManager.add(new Separator("editorconfigurator-settings"));
        toolBarManager.add(new Separator("editorconfigurator-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(EditorConfiguratorPlugin.INSTANCE.getString("_UI_EditorconfiguratorEditor_menu"), "org.topcased.modeler.editorconfiguratorMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(EditorConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(EditorConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(EditorConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(EditorConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
