 ...
 * </copyright>
 *
 * $Id: PropertiesConfiguratorActionBarContributor.java,v 1.1 2006/12/19 10:05:51 jako Exp $
 */
...
/**
 * This is the action bar contributor for the PropertiesConfigurator model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class PropertiesConfiguratorActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(ConfiguratorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        public void run()
        {
            try
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(ConfiguratorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
     ...
     * @generated
     */
    public PropertiesConfiguratorActionBarContributor()
    {
    ...
    {
        toolBarManager.add(new Separator("propertiesconfigurator-settings"));
        toolBarManager.add(new Separator("propertiesconfigurator-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_PropertiesConfiguratorEditor_menu"), "org.topcased.properties.configuratorMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
