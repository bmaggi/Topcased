...
import org.topcased.modeler.generator.internal.generators.doc.PDFDocGenerator;
 ...
 */
public class GeneratePDFDocAction implements IActionDelegate
{
        ...
        WorkspaceModifyOperation op = new WorkspaceModifyOperation()
        {
            public void execute(IProgressMonitor monitor) throws CoreException, InvocationTargetException, InterruptedException
            {
                ...
                try
                {
                    ...
                    IFile target = parent.getFile(new Path("documentation.pdf"));

                    EObject root = manager.getRootModelObject();
                    if (root instanceof EPackage)
                    {
                        DocGenerator generator = new PDFDocGenerator((EPackage) root, target);
