...
import org.topcased.modeler.generator.internal.generators.ServiceReadOnlyGenerator;
 ...
 */
public class GenerateServiceReadOnly implements IActionDelegate
{
    ...
    public void run(IAction action)
    {
        ...
        WorkspaceModifyOperation op = new WorkspaceModifyOperation()
        {
            ...
            {
                monitor.beginTask("Service Read Only Plugin generation process", 10);
                try
                {
                    ...
                    ServiceReadOnlyGenerator generator = new ServiceReadOnlyGenerator(configuration);
        ...
        catch (Exception e)
        {
            ...
            GeneratorPlugin.displayDialog(null, "An error occurred during the service read only generation", IStatus.ERROR);
        }
    }
