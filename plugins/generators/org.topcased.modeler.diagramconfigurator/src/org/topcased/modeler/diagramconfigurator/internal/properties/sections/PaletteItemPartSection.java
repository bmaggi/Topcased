 ...
 * @generated
 */
public class PaletteItemPartSection extends AbstractChooserPropertySection
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return DiagramconfiguratorPackage.eINSTANCE.getPaletteItem_Part();
    }
    ...
    {
        return ((PaletteItem) getEObject()).getPart();
    }
    ...
    {
        return getChoices(getEObject(), DiagramconfiguratorPackage.eINSTANCE.getPaletteItem_Part().getEType());
    }
