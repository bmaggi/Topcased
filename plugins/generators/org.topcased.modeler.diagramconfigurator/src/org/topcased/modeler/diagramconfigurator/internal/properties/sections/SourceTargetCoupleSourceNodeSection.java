 ...
 * @generated
 */
public class SourceTargetCoupleSourceNodeSection extends AbstractChooserPropertySection
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return DiagramconfiguratorPackage.eINSTANCE.getSourceTargetCouple_SourceNode();
    }
    ...
    {
        return ((SourceTargetCouple) getEObject()).getSourceNode();
    }
    ...
    {
        return getChoices(getEObject(), DiagramconfiguratorPackage.eINSTANCE.getSourceTargetCouple_SourceNode().getEType());
    }
