 ...
 * @generated
 */
public class DiagramConfigurationTemplateRootObjectSection extends AbstractChooserPropertySection
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return DiagramconfiguratorPackage.eINSTANCE.getDiagramConfiguration_TemplateRootObject();
    }
    ...
    {
        return ((DiagramConfiguration) getEObject()).getTemplateRootObject();
    }
    ...
    {
        return getChoices(getEObject(), DiagramconfiguratorPackage.eINSTANCE.getDiagramConfiguration_TemplateRootObject().getEType());
    }
