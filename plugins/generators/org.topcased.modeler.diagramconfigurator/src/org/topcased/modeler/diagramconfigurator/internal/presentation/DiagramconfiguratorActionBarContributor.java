 ...
 * </copyright>
 *
 * $Id: DiagramconfiguratorActionBarContributor.java,v 1.5 2007/04/18 12:21:27 jako Exp $
 */
...
/**
 * This is the action bar contributor for the Diagramconfigurator model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class DiagramconfiguratorActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        @Override
        public void run()
        {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        @Override
     ...
     * @generated
     */
    public DiagramconfiguratorActionBarContributor()
    {
    ...
    {
        toolBarManager.add(new Separator("diagramconfigurator-settings"));
        toolBarManager.add(new Separator("diagramconfigurator-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_DiagramconfiguratorEditor_menu"), "org.topcased.modeler.diagramconfiguratorMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        menuManager.insertBefore("edit", new Separator("new"));

        MenuManager submenuManager = null;

        submenuManager = new MenuManager(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.appendToGroup("new", submenuManager);

        submenuManager = new MenuManager(DiagramConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
