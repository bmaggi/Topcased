 ...
 * @generated
 */
public class DiagramConfigurationEditorConfiguratorSection extends AbstractChooserPropertySection
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return DiagramconfiguratorPackage.eINSTANCE.getDiagramConfiguration_EditorConfigurator();
    }
    ...
    {
        return ((DiagramConfiguration) getEObject()).getEditorConfigurator();
    }
    ...
    {
        return getChoices(getEObject(), DiagramconfiguratorPackage.eINSTANCE.getDiagramConfiguration_EditorConfigurator().getEType());
    }
