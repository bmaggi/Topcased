 ...
 * @generated
 */
public class SourceTargetCoupleContainerObjectSection extends AbstractChooserPropertySection
{
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    {
        return DiagramconfiguratorPackage.eINSTANCE.getSourceTargetCouple_ContainerObject();
    }
    ...
    {
        return ((SourceTargetCouple) getEObject()).getContainerObject();
    }
    ...
    {
        return getChoices(getEObject(), DiagramconfiguratorPackage.eINSTANCE.getSourceTargetCouple_ContainerObject().getEType());
    }
