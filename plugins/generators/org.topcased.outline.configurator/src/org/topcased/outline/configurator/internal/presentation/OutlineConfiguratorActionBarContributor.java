 ...
 * </copyright>
 *
 * $Id: OutlineConfiguratorActionBarContributor.java,v 1.1 2006/12/19 12:47:43 jako Exp $
 */
...
/**
 * This is the action bar contributor for the OutlineConfigurator model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class OutlineConfiguratorActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(ConfiguratorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
    {
        public void run()
        {
            try
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(ConfiguratorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
    {
     ...
     * @generated
     */
    public OutlineConfiguratorActionBarContributor()
    {
    ...
    {
        toolBarManager.add(new Separator("outlineconfigurator-settings")); //$NON-NLS-1$
        toolBarManager.add(new Separator("outlineconfigurator-additions")); //$NON-NLS-1$
    }
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_OutlineConfiguratorEditor_menu"), "org.topcased.outline.configuratorMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //
        createChildMenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
        submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

        submenuManager = new MenuManager(ConfiguratorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
