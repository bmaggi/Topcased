 ...
 * 
 * $Id: OCLRequirementPlugin.java,v 1.1 2009/03/19 13:40:49 clecamus Exp $
 * 
 *******************************************************************************/
 ...
 */
public class OCLRequirementPlugin extends EMFPlugin
{
    ...
    // The shared instance.
    public static OCLRequirementPlugin INSTANCE = new OCLRequirementPlugin();
    ...
    {
        return (getPlugin() != null) ? getPlugin().getBundle().getSymbolicName() : "org.eclipse.ocl.sam"; // last known bundle ID //$NON-NLS-1$
    }
     ...
     */
    public static OCLRequirementPlugin getInstance()
    {
        return INSTANCE;
    }
    ...
    public static class Implementation extends EMFPlugin.EclipsePlugin
    {
        ...
        public Implementation()
        {
            ...
            //
            OCLRequirementPlugin.plugin = this;
        }
    }
     ...
     * @param methodName The name of the method in which the throwable is being caught.
    ...
    public static void log(int severity, int code, String message, Throwable throwable)
    {
        ...
        {
            catching(OCLRequirementPlugin.class, "log", iae);//$NON-NLS-1$
        }
    }
