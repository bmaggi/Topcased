 ...
 * </copyright>
 *
 * $Id: NavigationCallExpImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.NavigationCallExpImpl#getQualifier <em>Qualifier</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.NavigationCallExpImpl#getNavigationSource <em>Navigation Source</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class NavigationCallExpImpl extends FeatureCallExpImpl implements NavigationCallExp
{
    ...
    {
        return OcldiPackage.Literals.NAVIGATION_CALL_EXP;
    }
    ...
    public EList<OCLExpression<BusinessType>> getQualifier()
    {
        if (qualifier == null)
        {
            qualifier = new EObjectContainmentEList<OCLExpression<BusinessType>>(OCLExpression.class, this, OcldiPackage.NAVIGATION_CALL_EXP__QUALIFIER);
        }
        return qualifier;
    }
        ...
        if (navigationSource != null && ((EObject) navigationSource).eIsProxy())
        {
            ...
            if (navigationSource != oldNavigationSource)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE, oldNavigationSource, navigationSource));
            }
        }
    ...
    public void setNavigationSource(EStructuralFeature newNavigationSource)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE, oldNavigationSource, navigationSource));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiPackage.NAVIGATION_CALL_EXP__QUALIFIER:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiPackage.NAVIGATION_CALL_EXP__QUALIFIER:
                return getQualifier();
            case OcldiPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.expressions.NavigationCallExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.NAVIGATION_CALL_EXP__QUALIFIER:
                    return OcldiPackage.NAVIGATION_CALL_EXP__QUALIFIER;
                case ExpressionsPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE:
                    return OcldiPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE;
                default:
                    return -1;
            }
        }
