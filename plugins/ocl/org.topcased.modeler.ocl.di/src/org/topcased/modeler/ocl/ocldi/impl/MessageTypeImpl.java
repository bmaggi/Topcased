 ...
 * </copyright>
 *
 * $Id: MessageTypeImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.MessageTypeImpl#getReferredOperation <em>Referred Operation</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.MessageTypeImpl#getReferredSignal <em>Referred Signal</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class MessageTypeImpl extends EClassImpl implements MessageType
{
    ...
    {
        return OcldiPackage.Literals.MESSAGE_TYPE;
    }
        ...
        if (referredOperation != null && ((EObject) referredOperation).eIsProxy())
        {
            ...
            if (referredOperation != oldReferredOperation)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiPackage.MESSAGE_TYPE__REFERRED_OPERATION, oldReferredOperation, referredOperation));
            }
        }
    ...
    public void setReferredOperation(EOperation newReferredOperation)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.MESSAGE_TYPE__REFERRED_OPERATION, oldReferredOperation, referredOperation));
    }
    ...
    public BusinessType getReferredSignal()
    {
        if (referredSignal != null && ((EObject) referredSignal).eIsProxy())
        {
            ...
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiPackage.MESSAGE_TYPE__REFERRED_SIGNAL, oldReferredSignal, referredSignal));
            }
        }
    ...
    public void setReferredSignal(BusinessType newReferredSignal)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.MESSAGE_TYPE__REFERRED_SIGNAL, oldReferredSignal, referredSignal));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiPackage.MESSAGE_TYPE__REFERRED_OPERATION:
                if (resolve)
                    return getReferredOperation();
                return basicGetReferredOperation();
            case OcldiPackage.MESSAGE_TYPE__REFERRED_SIGNAL:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.types.MessageType.class)
        {
            switch (baseFeatureID)
            {
                case TypesPackage.MESSAGE_TYPE__REFERRED_OPERATION:
                    return OcldiPackage.MESSAGE_TYPE__REFERRED_OPERATION;
                case TypesPackage.MESSAGE_TYPE__REFERRED_SIGNAL:
                    return OcldiPackage.MESSAGE_TYPE__REFERRED_SIGNAL;
                default:
                    return -1;
            }
        }
