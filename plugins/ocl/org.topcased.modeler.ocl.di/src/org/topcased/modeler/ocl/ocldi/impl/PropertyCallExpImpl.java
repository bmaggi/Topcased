 ...
 * </copyright>
 *
 * $Id: PropertyCallExpImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.PropertyCallExpImpl#getReferredProperty <em>Referred Property</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PropertyCallExpImpl extends NavigationCallExpImpl implements PropertyCallExp
{
    ...
    {
        return OcldiPackage.Literals.PROPERTY_CALL_EXP;
    }
        ...
        if (referredProperty != null && ((EObject) referredProperty).eIsProxy())
        {
            ...
            if (referredProperty != oldReferredProperty)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiPackage.PROPERTY_CALL_EXP__REFERRED_PROPERTY, oldReferredProperty, referredProperty));
            }
        }
    ...
    public void setReferredProperty(EStructuralFeature newReferredProperty)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.PROPERTY_CALL_EXP__REFERRED_PROPERTY, oldReferredProperty, referredProperty));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiPackage.PROPERTY_CALL_EXP__REFERRED_PROPERTY:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.expressions.PropertyCallExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.PROPERTY_CALL_EXP__REFERRED_PROPERTY:
                    return OcldiPackage.PROPERTY_CALL_EXP__REFERRED_PROPERTY;
                default:
                    return -1;
            }
        }
