 ...
 * </copyright>
 *
 * $Id: RequirementForeignMethods.java,v 1.1 2009/03/19 13:40:49 clecamus Exp $
 */
 ...
 */
public class RequirementForeignMethods
{
    /**
     * Not instantiable by clients.
     */
    private RequirementForeignMethods()
    {
        super();
    }
    ...
    /**
     * Foreign method for {@link EPackage#getEClassifier(String)} that accounts for possibility of underscore-escaped
     * names.
     * 
     * @param pkg a package
    ...
    /**
     * Foreign method for {@link EPackage#getESubpackages()} that searches by name and accounts for possibility of
