 ...
 * </copyright>
 *
 * $Id: OcldiSwitch.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
...
public class OcldiSwitch<T>
{
    ...
    protected T doSwitch(int classifierID, EObject theEObject)
    {
        switch (classifierID)
        {
            case OcldiPackage.ANY_TYPE: {
                ...
                if (result == null)
                    result = caseDiagramElement(anyType);
                if (result == null)
            ...
            case OcldiPackage.ELEMENT_TYPE: {
                ...
                if (result == null)
                    result = caseDiagramElement(elementType);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case OcldiPackage.INVALID_TYPE: {
                ...
                if (result == null)
                    result = caseDiagramElement(invalidType);
                if (result == null)
            ...
            case OcldiPackage.TYPE_TYPE: {
                ...
                if (result == null)
                    result = caseDiagramElement(typeType);
                if (result == null)
            ...
            case OcldiPackage.VOID_TYPE: {
                ...
                if (result == null)
                    result = caseDiagramElement(voidType);
                if (result == null)
            ...
            case OcldiPackage.COLLECTION_LITERAL_PART: {
            ...
            case OcldiPackage.FEATURE_CALL_EXP: {
            ...
            case OcldiPackage.NAVIGATION_CALL_EXP: {
            ...
            case OcldiPackage.NUMERIC_LITERAL_EXP: {
            ...
            case OcldiPackage.OCL_EXPRESSION: {
            ...
            case OcldiPackage.PRIMITIVE_LITERAL_EXP: {
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Diagram Element</em>'. <!-- begin-user-doc
     * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
     * -->
     * 
     * @param object the target of the switch.
