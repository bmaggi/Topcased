 ...
 * </copyright>
 *
 * $Id: IterateExpImpl.java,v 1.2 2009/04/20 08:10:34 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.IterateExpImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class IterateExpImpl extends LoopExpImpl implements IterateExp
{
    ...
    {
        return OcldiPackage.Literals.ITERATE_EXP;
    }
    ...
    public NotificationChain basicSetResult(Variable<BusinessType, EParameter> newResult, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.ITERATE_EXP__RESULT, oldResult, newResult);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setResult(Variable<BusinessType, EParameter> newResult)
    {
        if (newResult != result)
        {
            ...
            if (result != null)
                msgs = ((InternalEObject) result).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.ITERATE_EXP__RESULT, null, msgs);
            if (newResult != null)
                msgs = ((InternalEObject) newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.ITERATE_EXP__RESULT, null, msgs);
            msgs = basicSetResult(newResult, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.ITERATE_EXP__RESULT, newResult, newResult));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiPackage.ITERATE_EXP__RESULT:
        ...
        if (baseClass == org.eclipse.ocl.expressions.IterateExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.ITERATE_EXP__RESULT:
                    return OcldiPackage.ITERATE_EXP__RESULT;
                default:
                    return -1;
            }
        }
