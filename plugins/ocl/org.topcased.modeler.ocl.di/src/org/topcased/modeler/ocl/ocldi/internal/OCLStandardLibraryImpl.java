...
import org.topcased.modeler.ocl.ocldi.OcldiEnvironment;
import org.topcased.modeler.ocl.ocldi.OcldiEnvironmentFactory;
...
public final class OCLStandardLibraryImpl implements OCLStandardLibrary<EClassifier>
{
    ...
    private static EPackage init()
    {
        ...
        try
        {
            ...
            OCL_TYPE = (EClassifier) EcoreUtil.getObjectByType(stdlibPackage.getEClassifiers(), OcldiPackage.Literals.TYPE_TYPE);

            OCL_SET = (EClassifier) EcoreUtil.getObjectByType(stdlibPackage.getEClassifiers(), OcldiPackage.Literals.SET_TYPE);
            OCL_ORDERED_SET = (EClassifier) EcoreUtil.getObjectByType(stdlibPackage.getEClassifiers(), OcldiPackage.Literals.ORDERED_SET_TYPE);
            OCL_BAG = (EClassifier) EcoreUtil.getObjectByType(stdlibPackage.getEClassifiers(), OcldiPackage.Literals.BAG_TYPE);
            OCL_SEQUENCE = (EClassifier) EcoreUtil.getObjectByType(stdlibPackage.getEClassifiers(), OcldiPackage.Literals.SEQUENCE_TYPE);
    ...
    private static EPackage build()
    {
        ...
        Environment< ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? > old = Environment.Registry.INSTANCE.getEnvironmentFor(OcldiPackage.Literals.ANY_TYPE);
        ...
        OcldiEnvironment env = (OcldiEnvironment) OcldiEnvironmentFactory.INSTANCE.loadEnvironment(res);
        Environment.Registry.INSTANCE.registerEnvironment(env);

        OCL_ANY = (EClassifier) OcldiFactory.eINSTANCE.createAnyType();
        OCL_ELEMENT = (EClassifier) OcldiFactory.eINSTANCE.createElementType();
        OCL_BOOLEAN = OcldiFactory.eINSTANCE.createPrimitiveType();
        OCL_BOOLEAN.setName(PrimitiveType.BOOLEAN_NAME);
        OCL_INTEGER = OcldiFactory.eINSTANCE.createPrimitiveType();
        OCL_INTEGER.setName(PrimitiveType.INTEGER_NAME);
        OCL_UNLIMITED_NATURAL = OcldiFactory.eINSTANCE.createPrimitiveType();
        OCL_UNLIMITED_NATURAL.setName(PrimitiveType.UNLIMITED_NATURAL_NAME);
        OCL_REAL = OcldiFactory.eINSTANCE.createPrimitiveType();
        OCL_REAL.setName(PrimitiveType.REAL_NAME);
        OCL_STRING = OcldiFactory.eINSTANCE.createPrimitiveType();
        OCL_STRING.setName(PrimitiveType.STRING_NAME);
        OCL_VOID = (EClassifier) OcldiFactory.eINSTANCE.createVoidType();
        OCL_MESSAGE = (EClassifier) OcldiFactory.eINSTANCE.createMessageType();

        INVALID = (EClassifier) OcldiFactory.eINSTANCE.createInvalidType();

        OCL_T = (EClassifier) OcldiFactory.eINSTANCE.createAnyType();
        OCL_T.setName("T"); //$NON-NLS-1$
        OCL_T2 = (EClassifier) OcldiFactory.eINSTANCE.createAnyType();
        ...
        STATE = (EClassifier) OcldiFactory.eINSTANCE.createElementType();
        STATE.setName("State"); //$NON-NLS-1$
        OCL_EXPRESSION = (EClassifier) OcldiFactory.eINSTANCE.createElementType();
