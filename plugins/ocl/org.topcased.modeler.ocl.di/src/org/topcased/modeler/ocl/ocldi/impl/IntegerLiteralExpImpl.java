 ...
 * </copyright>
 *
 * $Id: IntegerLiteralExpImpl.java,v 1.2 2009/04/20 08:10:34 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.IntegerLiteralExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class IntegerLiteralExpImpl extends NumericLiteralExpImpl implements IntegerLiteralExp
{
    ...
    {
        return OcldiPackage.Literals.INTEGER_LITERAL_EXP;
    }
    ...
    public void setIntegerSymbol(Integer newIntegerSymbol)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL:
        ...
        if (baseClass == org.eclipse.ocl.expressions.IntegerLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL:
                    return OcldiPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL;
                default:
                    return -1;
            }
        }
