 ...
 * </copyright>
 *
 * $Id: ConstraintImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.ConstraintImpl#getSpecification <em>Specification</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.ConstraintImpl#getConstrainedElements <em>Constrained Elements</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.ConstraintImpl#getStereotype <em>Stereotype</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ConstraintImpl extends EClassifierImpl implements Constraint
{
    ...
    {
        return OcldiPackage.Literals.CONSTRAINT;
    }
    ...
    public NotificationChain basicSetSpecification(ExpressionInOCL<EClassifier, EParameter> newSpecification, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.CONSTRAINT__SPECIFICATION, oldSpecification, newSpecification);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSpecification(ExpressionInOCL<EClassifier, EParameter> newSpecification)
    {
        if (newSpecification != specification)
        {
            ...
            if (specification != null)
                msgs = ((InternalEObject) specification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.CONSTRAINT__SPECIFICATION, null, msgs);
            if (newSpecification != null)
                msgs = ((InternalEObject) newSpecification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.CONSTRAINT__SPECIFICATION, null, msgs);
            msgs = basicSetSpecification(newSpecification, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.CONSTRAINT__SPECIFICATION, newSpecification, newSpecification));
    }
    ...
    public EList<BusinessType> getConstrainedElements()
    {
        ...
        {
            constrainedElements = new EObjectResolvingEList<BusinessType>(BusinessType.class, this, OcldiPackage.CONSTRAINT__CONSTRAINED_ELEMENTS);
        }
    ...
    public void setStereotype(String newStereotype)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.CONSTRAINT__STEREOTYPE, oldStereotype, stereotype));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiPackage.CONSTRAINT__SPECIFICATION:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            ...
            case OcldiPackage.CONSTRAINT__CONSTRAINED_ELEMENTS:
                return getConstrainedElements();
            case OcldiPackage.CONSTRAINT__STEREOTYPE:
