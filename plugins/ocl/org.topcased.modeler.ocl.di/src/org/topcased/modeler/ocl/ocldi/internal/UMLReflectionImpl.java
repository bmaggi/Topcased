 ...
 * </copyright>
 *
 * $Id: UMLReflectionImpl.java,v 1.1 2009/03/19 13:40:49 clecamus Exp $
 */
        ...
        org.eclipse.ocl.utilities.UMLReflection<EPackage, EClassifier, EOperation, EStructuralFeature, EEnumLiteral, EParameter, EObject, CallOperationAction, SendSignalAction, Constraint>
{
    ...
    {
        CallOperationAction result = OcldiFactory.eINSTANCE.createCallOperationAction();
    ...
    {
        SendSignalAction result = OcldiFactory.eINSTANCE.createSendSignalAction();
    ...
    {
        return OcldiFactory.eINSTANCE.createConstraint();
    }
    ...
    {
        return OcldiFactory.eINSTANCE.createExpressionInOCL();
    }
