 ...
 * </copyright>
 *
 * $Id: OcldiPackageImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * @generated
 */
public class OcldiPackageImpl extends EPackageImpl implements OcldiPackage
{
    /**
     ...
     * @see org.topcased.modeler.ocl.ocldi.OcldiPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private OcldiPackageImpl()
    {
        super(eNS_URI, OcldiFactory.eINSTANCE);
    }
     ...
     * @generated
     */
    public static OcldiPackage init()
    {
        if (isInited)
            return (OcldiPackage) EPackage.Registry.INSTANCE.getEPackage(OcldiPackage.eNS_URI);

        // Obtain or create and register package
        OcldiPackageImpl theOcldiPackage = (OcldiPackageImpl) (EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof OcldiPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI)
                : new OcldiPackageImpl());
        ...
        theOcldiPackage.createPackageContents();

        // Initialize created meta-data
        theOcldiPackage.initializePackageContents();

        // Mark meta-data to indicate it can't be changed
        theOcldiPackage.freeze();

        return theOcldiPackage;
    }
     ...
     * @generated
     */
    public OcldiFactory getOcldiFactory()
    {
        return (OcldiFactory) getEFactoryInstance();
    }
    ...
    public void initializePackageContents()
    {
        ...
        g1.getETypeArguments().add(g2);
        variableExpEClass.getEGenericSuperTypes().add(g1);
        businessTypeEClass.getESuperTypes().add(theDiagramInterchangePackage.getDiagramElement());
