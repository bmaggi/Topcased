 ...
 * </copyright>
 *
 * $Id: CollectionRangeImpl.java,v 1.2 2009/04/20 08:10:34 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.CollectionRangeImpl#getFirst <em>First</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.CollectionRangeImpl#getLast <em>Last</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class CollectionRangeImpl extends CollectionLiteralPartImpl implements CollectionRange
{
    ...
    {
        return OcldiPackage.Literals.COLLECTION_RANGE;
    }
    ...
    public NotificationChain basicSetFirst(OCLExpression<BusinessType> newFirst, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.COLLECTION_RANGE__FIRST, oldFirst, newFirst);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFirst(OCLExpression<BusinessType> newFirst)
    {
        if (newFirst != first)
        {
            ...
            if (first != null)
                msgs = ((InternalEObject) first).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.COLLECTION_RANGE__FIRST, null, msgs);
            if (newFirst != null)
                msgs = ((InternalEObject) newFirst).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.COLLECTION_RANGE__FIRST, null, msgs);
            msgs = basicSetFirst(newFirst, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.COLLECTION_RANGE__FIRST, newFirst, newFirst));
    }
    ...
    public NotificationChain basicSetLast(OCLExpression<BusinessType> newLast, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.COLLECTION_RANGE__LAST, oldLast, newLast);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setLast(OCLExpression<BusinessType> newLast)
    {
        if (newLast != last)
        {
            NotificationChain msgs = null;
            if (last != null)
                msgs = ((InternalEObject) last).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.COLLECTION_RANGE__LAST, null, msgs);
            if (newLast != null)
                msgs = ((InternalEObject) newLast).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.COLLECTION_RANGE__LAST, null, msgs);
            msgs = basicSetLast(newLast, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.COLLECTION_RANGE__LAST, newLast, newLast));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiPackage.COLLECTION_RANGE__FIRST:
                return basicSetFirst(null, msgs);
            case OcldiPackage.COLLECTION_RANGE__LAST:
        ...
        if (baseClass == org.eclipse.ocl.expressions.CollectionRange.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.COLLECTION_RANGE__FIRST:
                    return OcldiPackage.COLLECTION_RANGE__FIRST;
                case ExpressionsPackage.COLLECTION_RANGE__LAST:
                    return OcldiPackage.COLLECTION_RANGE__LAST;
                default:
                    return -1;
            }
        }
