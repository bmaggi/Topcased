 ...
 * </copyright>
 *
 * $Id: FeatureCallExpImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.FeatureCallExpImpl#isMarkedPre <em>Marked Pre</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class FeatureCallExpImpl extends CallExpImpl implements FeatureCallExp
{
    ...
    {
        return OcldiPackage.Literals.FEATURE_CALL_EXP;
    }
    ...
    public void setMarkedPre(boolean newMarkedPre)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.FEATURE_CALL_EXP__MARKED_PRE, oldMarkedPre, markedPre));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiPackage.FEATURE_CALL_EXP__MARKED_PRE:
        ...
        if (baseClass == org.eclipse.ocl.expressions.FeatureCallExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.FEATURE_CALL_EXP__MARKED_PRE:
                    return OcldiPackage.FEATURE_CALL_EXP__MARKED_PRE;
                default:
                    return -1;
            }
        }
