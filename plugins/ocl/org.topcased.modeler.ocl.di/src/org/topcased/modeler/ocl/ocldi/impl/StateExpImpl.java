 ...
 * </copyright>
 *
 * $Id: StateExpImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.StateExpImpl#getReferredState <em>Referred State</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class StateExpImpl extends OCLExpressionImpl implements StateExp
{
    ...
    {
        return OcldiPackage.Literals.STATE_EXP;
    }
        ...
        if (referredState != null && ((EObject) referredState).eIsProxy())
        {
            ...
            if (referredState != oldReferredState)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiPackage.STATE_EXP__REFERRED_STATE, oldReferredState, referredState));
            }
        }
    ...
    public void setReferredState(EObject newReferredState)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.STATE_EXP__REFERRED_STATE, oldReferredState, referredState));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiPackage.STATE_EXP__REFERRED_STATE:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.expressions.StateExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.STATE_EXP__REFERRED_STATE:
                    return OcldiPackage.STATE_EXP__REFERRED_STATE;
                default:
                    return -1;
            }
        }
