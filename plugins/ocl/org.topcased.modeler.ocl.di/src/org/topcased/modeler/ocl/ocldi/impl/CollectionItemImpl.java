 ...
 * </copyright>
 *
 * $Id: CollectionItemImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.CollectionItemImpl#getItem <em>Item</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class CollectionItemImpl extends CollectionLiteralPartImpl implements CollectionItem
{
    ...
    {
        return OcldiPackage.Literals.COLLECTION_ITEM;
    }
    ...
    public NotificationChain basicSetItem(OCLExpression<BusinessType> newItem, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.COLLECTION_ITEM__ITEM, oldItem, newItem);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setItem(OCLExpression<BusinessType> newItem)
    {
        if (newItem != item)
        {
            ...
            if (item != null)
                msgs = ((InternalEObject) item).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.COLLECTION_ITEM__ITEM, null, msgs);
            if (newItem != null)
                msgs = ((InternalEObject) newItem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.COLLECTION_ITEM__ITEM, null, msgs);
            msgs = basicSetItem(newItem, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.COLLECTION_ITEM__ITEM, newItem, newItem));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiPackage.COLLECTION_ITEM__ITEM:
        ...
        if (baseClass == org.eclipse.ocl.expressions.CollectionItem.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.COLLECTION_ITEM__ITEM:
                    return OcldiPackage.COLLECTION_ITEM__ITEM;
                default:
                    return -1;
            }
        }
