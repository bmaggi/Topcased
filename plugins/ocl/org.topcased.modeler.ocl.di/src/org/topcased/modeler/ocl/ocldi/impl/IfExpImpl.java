 ...
 * </copyright>
 *
 * $Id: IfExpImpl.java,v 1.2 2009/04/20 08:10:35 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.IfExpImpl#getCondition <em>Condition</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.IfExpImpl#getThenExpression <em>Then Expression</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldi.impl.IfExpImpl#getElseExpression <em>Else Expression</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class IfExpImpl extends OCLExpressionImpl implements IfExp
{
    ...
    {
        return OcldiPackage.Literals.IF_EXP;
    }
    ...
    public NotificationChain basicSetCondition(OCLExpression<BusinessType> newCondition, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.IF_EXP__CONDITION, oldCondition, newCondition);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setCondition(OCLExpression<BusinessType> newCondition)
    {
        if (newCondition != condition)
        {
            ...
            if (condition != null)
                msgs = ((InternalEObject) condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.IF_EXP__CONDITION, null, msgs);
            if (newCondition != null)
                msgs = ((InternalEObject) newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.IF_EXP__CONDITION, null, msgs);
            msgs = basicSetCondition(newCondition, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.IF_EXP__CONDITION, newCondition, newCondition));
    }
    ...
    public NotificationChain basicSetThenExpression(OCLExpression<BusinessType> newThenExpression, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.IF_EXP__THEN_EXPRESSION, oldThenExpression, newThenExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setThenExpression(OCLExpression<BusinessType> newThenExpression)
    {
        if (newThenExpression != thenExpression)
        {
            ...
            if (thenExpression != null)
                msgs = ((InternalEObject) thenExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.IF_EXP__THEN_EXPRESSION, null, msgs);
            if (newThenExpression != null)
                msgs = ((InternalEObject) newThenExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.IF_EXP__THEN_EXPRESSION, null, msgs);
            msgs = basicSetThenExpression(newThenExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.IF_EXP__THEN_EXPRESSION, newThenExpression, newThenExpression));
    }
    ...
    public NotificationChain basicSetElseExpression(OCLExpression<BusinessType> newElseExpression, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiPackage.IF_EXP__ELSE_EXPRESSION, oldElseExpression, newElseExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setElseExpression(OCLExpression<BusinessType> newElseExpression)
    {
        if (newElseExpression != elseExpression)
        {
            ...
            if (elseExpression != null)
                msgs = ((InternalEObject) elseExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.IF_EXP__ELSE_EXPRESSION, null, msgs);
            if (newElseExpression != null)
                msgs = ((InternalEObject) newElseExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiPackage.IF_EXP__ELSE_EXPRESSION, null, msgs);
            msgs = basicSetElseExpression(newElseExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiPackage.IF_EXP__ELSE_EXPRESSION, newElseExpression, newElseExpression));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiPackage.IF_EXP__CONDITION:
                return basicSetCondition(null, msgs);
            case OcldiPackage.IF_EXP__THEN_EXPRESSION:
                return basicSetThenExpression(null, msgs);
            case OcldiPackage.IF_EXP__ELSE_EXPRESSION:
        ...
        if (baseClass == org.eclipse.ocl.expressions.IfExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.IF_EXP__CONDITION:
                    return OcldiPackage.IF_EXP__CONDITION;
                case ExpressionsPackage.IF_EXP__THEN_EXPRESSION:
                    return OcldiPackage.IF_EXP__THEN_EXPRESSION;
                case ExpressionsPackage.IF_EXP__ELSE_EXPRESSION:
                    return OcldiPackage.IF_EXP__ELSE_EXPRESSION;
                default:
                    return -1;
            }
        }
