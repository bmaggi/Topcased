 ...
 * </copyright>
 *
 * $Id: TypeTypeImpl.java,v 1.2 2009/04/20 08:07:07 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.TypeTypeImpl#getReferredType <em>Referred Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TypeTypeImpl extends BusinessTypeImpl implements TypeType
{
    ...
    {
        return OcldiagramsPackage.Literals.TYPE_TYPE;
    }
        ...
        if (referredType != null && ((EObject) referredType).eIsProxy())
        {
            ...
            if (referredType != oldReferredType)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiagramsPackage.TYPE_TYPE__REFERRED_TYPE, oldReferredType, referredType));
            }
        }
        return referredType;
    }
    ...
    public void setReferredType(BusinessType newReferredType)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.TYPE_TYPE__REFERRED_TYPE, oldReferredType, referredType));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.TYPE_TYPE__REFERRED_TYPE:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.types.TypeType.class)
        {
            switch (baseFeatureID)
            {
                case TypesPackage.TYPE_TYPE__REFERRED_TYPE:
                    return OcldiagramsPackage.TYPE_TYPE__REFERRED_TYPE;
                default:
                    return -1;
            }
        }
