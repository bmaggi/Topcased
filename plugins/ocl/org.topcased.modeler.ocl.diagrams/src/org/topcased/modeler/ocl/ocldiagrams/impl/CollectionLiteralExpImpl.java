 ...
 * </copyright>
 *
 * $Id: CollectionLiteralExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionLiteralExpImpl#getKind <em>Kind</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionLiteralExpImpl#getPart <em>Part</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionLiteralExpImpl#isSimpleRange <em>Simple Range</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class CollectionLiteralExpImpl extends LiteralExpImpl implements CollectionLiteralExp
{
    ...
    {
        return OcldiagramsPackage.Literals.COLLECTION_LITERAL_EXP;
    }
    ...
    public void setKind(CollectionKind newKind)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.COLLECTION_LITERAL_EXP__KIND, oldKind, kind));
    }
    ...
    public EList<CollectionLiteralPart<BusinessType>> getPart()
    {
        if (part == null)
        {
            part = new EObjectContainmentEList<CollectionLiteralPart<BusinessType>>(CollectionLiteralPart.class, this, OcldiagramsPackage.COLLECTION_LITERAL_EXP__PART);
        }
        return part;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.COLLECTION_LITERAL_EXP__PART:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.COLLECTION_LITERAL_EXP__KIND:
                return getKind();
            case OcldiagramsPackage.COLLECTION_LITERAL_EXP__PART:
                return getPart();
            case OcldiagramsPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE:
        ...
        if (baseClass == org.eclipse.ocl.expressions.CollectionLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.COLLECTION_LITERAL_EXP__KIND:
                    return OcldiagramsPackage.COLLECTION_LITERAL_EXP__KIND;
                case ExpressionsPackage.COLLECTION_LITERAL_EXP__PART:
                    return OcldiagramsPackage.COLLECTION_LITERAL_EXP__PART;
                case ExpressionsPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE:
                    return OcldiagramsPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE;
                default:
                    return -1;
            }
        }
