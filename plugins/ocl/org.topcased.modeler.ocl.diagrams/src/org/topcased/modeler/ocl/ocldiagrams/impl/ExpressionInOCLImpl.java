 ...
 * </copyright>
 *
 * $Id: ExpressionInOCLImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.ExpressionInOCLImpl#getBodyExpression <em>Body Expression</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.ExpressionInOCLImpl#getContextVariable <em>Context Variable
 * </em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.ExpressionInOCLImpl#getResultVariable <em>Result Variable</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.ExpressionInOCLImpl#getParameterVariable <em>Parameter Variable
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class ExpressionInOCLImpl extends EObjectImpl implements ExpressionInOCL
{
    ...
    {
        return OcldiagramsPackage.Literals.EXPRESSION_IN_OCL;
    }
    ...
    public NotificationChain basicSetBodyExpression(OCLExpression<EClassifier> newBodyExpression, NotificationChain msgs)
    {
        ...
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, oldBodyExpression, newBodyExpression);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setBodyExpression(OCLExpression<EClassifier> newBodyExpression)
    {
        if (newBodyExpression != bodyExpression)
        {
            ...
            if (bodyExpression != null)
                msgs = ((InternalEObject) bodyExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, null, msgs);
            if (newBodyExpression != null)
                msgs = ((InternalEObject) newBodyExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, null, msgs);
            msgs = basicSetBodyExpression(newBodyExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.EXPRESSION_IN_OCL__BODY_EXPRESSION, newBodyExpression, newBodyExpression));
    }
    ...
    public NotificationChain basicSetContextVariable(Variable<EClassifier, EParameter> newContextVariable, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, oldContextVariable, newContextVariable);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setContextVariable(Variable<EClassifier, EParameter> newContextVariable)
    {
        if (newContextVariable != contextVariable)
        {
            ...
            if (contextVariable != null)
                msgs = ((InternalEObject) contextVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, null, msgs);
            if (newContextVariable != null)
                msgs = ((InternalEObject) newContextVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, null, msgs);
            msgs = basicSetContextVariable(newContextVariable, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE, newContextVariable, newContextVariable));
    }
    ...
    public NotificationChain basicSetResultVariable(Variable<EClassifier, EParameter> newResultVariable, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, oldResultVariable, newResultVariable);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setResultVariable(Variable<EClassifier, EParameter> newResultVariable)
    {
        if (newResultVariable != resultVariable)
        {
            ...
            if (resultVariable != null)
                msgs = ((InternalEObject) resultVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, null, msgs);
            if (newResultVariable != null)
                msgs = ((InternalEObject) newResultVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, null, msgs);
            msgs = basicSetResultVariable(newResultVariable, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.EXPRESSION_IN_OCL__RESULT_VARIABLE, newResultVariable, newResultVariable));
    }
    ...
    public EList<Variable<EClassifier, EParameter>> getParameterVariable()
    {
        ...
        {
            parameterVariable = new EObjectContainmentEList<Variable<EClassifier, EParameter>>(Variable.class, this, OcldiagramsPackage.EXPRESSION_IN_OCL__PARAMETER_VARIABLE);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.EXPRESSION_IN_OCL__BODY_EXPRESSION:
                return basicSetBodyExpression(null, msgs);
            case OcldiagramsPackage.EXPRESSION_IN_OCL__CONTEXT_VARIABLE:
                return basicSetContextVariable(null, msgs);
            case OcldiagramsPackage.EXPRESSION_IN_OCL__RESULT_VARIABLE:
                return basicSetResultVariable(null, msgs);
            case OcldiagramsPackage.EXPRESSION_IN_OCL__PARAMETER_VARIABLE:
