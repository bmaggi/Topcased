 ...
 * </copyright>
 *
 * $Id: TypeExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.TypeExpImpl#getReferredType <em>Referred Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TypeExpImpl extends OCLExpressionImpl implements TypeExp
{
    ...
    {
        return OcldiagramsPackage.Literals.TYPE_EXP;
    }
        ...
        if (referredType != null && ((EObject) referredType).eIsProxy())
        {
            ...
            if (referredType != oldReferredType)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiagramsPackage.TYPE_EXP__REFERRED_TYPE, oldReferredType, referredType));
            }
        }
        return referredType;
    }
    ...
    public void setReferredType(BusinessType newReferredType)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.TYPE_EXP__REFERRED_TYPE, oldReferredType, referredType));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.TYPE_EXP__REFERRED_TYPE:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.expressions.TypeExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.TYPE_EXP__REFERRED_TYPE:
                    return OcldiagramsPackage.TYPE_EXP__REFERRED_TYPE;
                default:
                    return -1;
            }
        }
