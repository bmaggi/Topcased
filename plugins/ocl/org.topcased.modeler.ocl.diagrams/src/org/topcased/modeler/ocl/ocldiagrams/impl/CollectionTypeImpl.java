 ...
 * </copyright>
 *
 * $Id: CollectionTypeImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionTypeImpl#getStartPosition <em>Start Position</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionTypeImpl#getEndPosition <em>End Position</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionTypeImpl#getTypeStartPosition <em>Type Start Position
 * </em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionTypeImpl#getTypeEndPosition <em>Type End Position
 * </em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionTypeImpl#getElementType <em>Element Type</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CollectionTypeImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class CollectionTypeImpl extends EClassifierImpl implements CollectionType
{
    ...
    {
        return OcldiagramsPackage.Literals.COLLECTION_TYPE;
    }
    ...
    public void setStartPosition(int newStartPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.COLLECTION_TYPE__START_POSITION, oldStartPosition, startPosition));
    }
    ...
    public void setEndPosition(int newEndPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.COLLECTION_TYPE__END_POSITION, oldEndPosition, endPosition));
    }
    ...
    public void setTypeStartPosition(int newTypeStartPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.COLLECTION_TYPE__TYPE_START_POSITION, oldTypeStartPosition, typeStartPosition));
    }
    ...
    public void setTypeEndPosition(int newTypeEndPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.COLLECTION_TYPE__TYPE_END_POSITION, oldTypeEndPosition, typeEndPosition));
    }
    ...
    public EClassifier getElementType()
    {
        if (elementType != null && ((EObject) elementType).eIsProxy())
        {
            ...
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiagramsPackage.COLLECTION_TYPE__ELEMENT_TYPE, oldElementType, elementType));
            }
        }
        return elementType;
    }
    ...
    public void setElementType(EClassifier newElementType)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.COLLECTION_TYPE__ELEMENT_TYPE, oldElementType, elementType));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.COLLECTION_TYPE__START_POSITION:
                return new Integer(getStartPosition());
            case OcldiagramsPackage.COLLECTION_TYPE__END_POSITION:
                return new Integer(getEndPosition());
            case OcldiagramsPackage.COLLECTION_TYPE__TYPE_START_POSITION:
                return new Integer(getTypeStartPosition());
            case OcldiagramsPackage.COLLECTION_TYPE__TYPE_END_POSITION:
                return new Integer(getTypeEndPosition());
            case OcldiagramsPackage.COLLECTION_TYPE__ELEMENT_TYPE:
                if (resolve)
                    return getElementType();
                return basicGetElementType();
            case OcldiagramsPackage.COLLECTION_TYPE__KIND:
                return getKind();
        }
        ...
        if (baseClass == ASTNode.class)
        {
            switch (baseFeatureID)
            {
                case UtilitiesPackage.AST_NODE__START_POSITION:
                    return OcldiagramsPackage.COLLECTION_TYPE__START_POSITION;
                case UtilitiesPackage.AST_NODE__END_POSITION:
                    return OcldiagramsPackage.COLLECTION_TYPE__END_POSITION;
                default:
                    return -1;
            }
        }
        if (baseClass == TypedASTNode.class)
        {
            switch (baseFeatureID)
            {
                case UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION:
                    return OcldiagramsPackage.COLLECTION_TYPE__TYPE_START_POSITION;
                case UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION:
                    return OcldiagramsPackage.COLLECTION_TYPE__TYPE_END_POSITION;
                default:
                    return -1;
            }
        }
        if (baseClass == org.eclipse.ocl.types.CollectionType.class)
        {
            switch (baseFeatureID)
            {
                case TypesPackage.COLLECTION_TYPE__ELEMENT_TYPE:
                    return OcldiagramsPackage.COLLECTION_TYPE__ELEMENT_TYPE;
                case TypesPackage.COLLECTION_TYPE__KIND:
                    return OcldiagramsPackage.COLLECTION_TYPE__KIND;
                default:
                    return -1;
            }
        }
