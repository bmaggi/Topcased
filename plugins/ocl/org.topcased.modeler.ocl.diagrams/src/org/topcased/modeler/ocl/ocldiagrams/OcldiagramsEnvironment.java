 ...
 */
public class OcldiagramsEnvironment extends EcoreEnvironment
{
     ...
     */
    protected OcldiagramsEnvironment(EPackage.Registry reg)
    {
        super(reg);
     ...
     */
    protected OcldiagramsEnvironment(OcldiagramsEnvironment parent)
    {
        super(parent);
    }
    ...
    protected OcldiagramsEnvironment(EPackage.Registry reg, Resource resource)
    {
        super(reg, resource);
    }
    ...
    private EOperation createOperation(EOperation sourceOp)
    {
        ...
        annotation.setSource("OcldiagramsEnvironment");
