 ...
 * </copyright>
 *
 * $Id: UnlimitedNaturalLiteralExpImpl.java,v 1.2 2009/04/20 08:07:07 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.UnlimitedNaturalLiteralExpImpl#getIntegerSymbol <em>Integer
 * Symbol</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.UnlimitedNaturalLiteralExpImpl#isUnlimited <em>Unlimited</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class UnlimitedNaturalLiteralExpImpl extends NumericLiteralExpImpl implements UnlimitedNaturalLiteralExp
{
    ...
    {
        return OcldiagramsPackage.Literals.UNLIMITED_NATURAL_LITERAL_EXP;
    }
    ...
    public void setIntegerSymbol(Integer newIntegerSymbol)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.UNLIMITED_NATURAL_LITERAL_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.UNLIMITED_NATURAL_LITERAL_EXP__INTEGER_SYMBOL:
                return getIntegerSymbol();
            case OcldiagramsPackage.UNLIMITED_NATURAL_LITERAL_EXP__UNLIMITED:
        ...
        if (baseClass == org.eclipse.ocl.expressions.UnlimitedNaturalLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.UNLIMITED_NATURAL_LITERAL_EXP__INTEGER_SYMBOL:
                    return OcldiagramsPackage.UNLIMITED_NATURAL_LITERAL_EXP__INTEGER_SYMBOL;
                case ExpressionsPackage.UNLIMITED_NATURAL_LITERAL_EXP__UNLIMITED:
                    return OcldiagramsPackage.UNLIMITED_NATURAL_LITERAL_EXP__UNLIMITED;
                default:
                    return -1;
            }
        }
