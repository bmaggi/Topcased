 ...
 * </copyright>
 *
 * $Id: SendSignalActionImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.SendSignalActionImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class SendSignalActionImpl extends EObjectImpl implements SendSignalAction
{
    ...
    {
        return OcldiagramsPackage.Literals.SEND_SIGNAL_ACTION;
    }
        ...
        if (signal != null && signal.eIsProxy())
        {
            ...
            if (signal != oldSignal)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiagramsPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
            }
        }
        return signal;
    }
    ...
    public void setSignal(BusinessType newSignal)
    {
        ...
        signal = newSignal;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.SEND_SIGNAL_ACTION__SIGNAL:
                if (resolve)
                    return getSignal();
