 ...
 */
public class OcldiagramsEvaluationEnvironment extends AbstractEvaluationEnvironment<EClassifier, EOperation, EStructuralFeature, EClass, EObject> implements
        EvaluationEnvironment.Enumerations<EEnumLiteral>
{

    /**
     * Initializes me.
     */
    public OcldiagramsEvaluationEnvironment()
    {
        super();
    }
     ...
     */
    public OcldiagramsEvaluationEnvironment(EvaluationEnvironment<EClassifier, EOperation, EStructuralFeature, EClass, EObject> parent)
    {
        super(parent);
    }
    ...
    {
        if (operation.getEAnnotation("OcldiagramsEnvironment") != null)
        {
    ...
    {
        return OcldiagramsEnvironmentFactory.oclType(object);
    }
