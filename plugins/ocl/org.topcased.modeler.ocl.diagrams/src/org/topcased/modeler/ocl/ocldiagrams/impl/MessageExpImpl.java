 ...
 * </copyright>
 *
 * $Id: MessageExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Message Exp</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.MessageExpImpl#getPropertyStartPosition <em>Property Start
 * Position</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.MessageExpImpl#getPropertyEndPosition <em>Property End Position
 * </em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.MessageExpImpl#getTarget <em>Target</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.MessageExpImpl#getArgument <em>Argument</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.MessageExpImpl#getCalledOperation <em>Called Operation</em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.MessageExpImpl#getSentSignal <em>Sent Signal</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class MessageExpImpl extends OCLExpressionImpl implements MessageExp
{
     ...
     * @ordered
     */
    protected OCLExpression<BusinessType> target;
    ...
    {
        return OcldiagramsPackage.Literals.MESSAGE_EXP;
    }
    ...
    public void setPropertyStartPosition(int newPropertyStartPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__PROPERTY_START_POSITION, oldPropertyStartPosition, propertyStartPosition));
    }
    ...
    public void setPropertyEndPosition(int newPropertyEndPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__PROPERTY_END_POSITION, oldPropertyEndPosition, propertyEndPosition));
    }
     ...
     * @generated
     */
    public OCLExpression<BusinessType> getTarget()
    {
        return target;
    }
     ...
     * @generated
     */
    public NotificationChain basicSetTarget(OCLExpression<BusinessType> newTarget, NotificationChain msgs)
    {
        OCLExpression<BusinessType> oldTarget = target;
        target = newTarget;
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__TARGET, oldTarget, newTarget);
            if (msgs == null)
                msgs = notification;
            else
     ...
     * @generated
     */
    public void setTarget(OCLExpression<BusinessType> newTarget)
    {
        if (newTarget != target)
        {
            NotificationChain msgs = null;
            if (target != null)
                msgs = ((InternalEObject) target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.MESSAGE_EXP__TARGET, null, msgs);
            if (newTarget != null)
                msgs = ((InternalEObject) newTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.MESSAGE_EXP__TARGET, null, msgs);
            msgs = basicSetTarget(newTarget, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__TARGET, newTarget, newTarget));
    }
    ...
    public EList<OCLExpression<BusinessType>> getArgument()
    {
        if (argument == null)
        {
            argument = new EObjectContainmentEList<OCLExpression<BusinessType>>(OCLExpression.class, this, OcldiagramsPackage.MESSAGE_EXP__ARGUMENT);
        }
        return argument;
    }
    ...
    public NotificationChain basicSetCalledOperation(CallOperationAction newCalledOperation, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__CALLED_OPERATION, oldCalledOperation, newCalledOperation);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCalledOperation(CallOperationAction newCalledOperation)
    {
        if (newCalledOperation != calledOperation)
        {
            ...
            if (calledOperation != null)
                msgs = ((InternalEObject) calledOperation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.MESSAGE_EXP__CALLED_OPERATION, null, msgs);
            if (newCalledOperation != null)
                msgs = ((InternalEObject) newCalledOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.MESSAGE_EXP__CALLED_OPERATION, null, msgs);
            msgs = basicSetCalledOperation(newCalledOperation, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__CALLED_OPERATION, newCalledOperation, newCalledOperation));
    }
    ...
    public NotificationChain basicSetSentSignal(SendSignalAction newSentSignal, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__SENT_SIGNAL, oldSentSignal, newSentSignal);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSentSignal(SendSignalAction newSentSignal)
    {
        if (newSentSignal != sentSignal)
        {
            NotificationChain msgs = null;
            if (sentSignal != null)
                msgs = ((InternalEObject) sentSignal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.MESSAGE_EXP__SENT_SIGNAL, null, msgs);
            if (newSentSignal != null)
                msgs = ((InternalEObject) newSentSignal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.MESSAGE_EXP__SENT_SIGNAL, null, msgs);
            msgs = basicSetSentSignal(newSentSignal, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.MESSAGE_EXP__SENT_SIGNAL, newSentSignal, newSentSignal));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.MESSAGE_EXP__TARGET:
                return basicSetTarget(null, msgs);
            case OcldiagramsPackage.MESSAGE_EXP__ARGUMENT:
                return ((InternalEList< ? >) getArgument()).basicRemove(otherEnd, msgs);
            case OcldiagramsPackage.MESSAGE_EXP__CALLED_OPERATION:
                return basicSetCalledOperation(null, msgs);
            case OcldiagramsPackage.MESSAGE_EXP__SENT_SIGNAL:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.MESSAGE_EXP__PROPERTY_START_POSITION:
                return new Integer(getPropertyStartPosition());
            case OcldiagramsPackage.MESSAGE_EXP__PROPERTY_END_POSITION:
    ...
    public void eSet(int featureID, Object newValue)
    {
        switch (featureID)
        {
            ...
            case OcldiagramsPackage.MESSAGE_EXP__PROPERTY_END_POSITION:
                ...
                return;
            case OcldiagramsPackage.MESSAGE_EXP__TARGET:
                setTarget((OCLExpression<BusinessType>) newValue);
                return;
            case OcldiagramsPackage.MESSAGE_EXP__ARGUMENT:
                getArgument().clear();
    ...
    public void eUnset(int featureID)
    {
        switch (featureID)
        {
            ...
            case OcldiagramsPackage.MESSAGE_EXP__PROPERTY_END_POSITION:
                ...
                return;
            case OcldiagramsPackage.MESSAGE_EXP__TARGET:
                setTarget((OCLExpression<BusinessType>) null);
                return;
            case OcldiagramsPackage.MESSAGE_EXP__ARGUMENT:
                getArgument().clear();
                return;
        ...
        if (baseClass == CallingASTNode.class)
        {
            switch (baseFeatureID)
            {
                case UtilitiesPackage.CALLING_AST_NODE__PROPERTY_START_POSITION:
                    return OcldiagramsPackage.MESSAGE_EXP__PROPERTY_START_POSITION;
                case UtilitiesPackage.CALLING_AST_NODE__PROPERTY_END_POSITION:
                    return OcldiagramsPackage.MESSAGE_EXP__PROPERTY_END_POSITION;
                default:
                    return -1;
            }
        }
        if (baseClass == org.eclipse.ocl.expressions.MessageExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.MESSAGE_EXP__TARGET:
                    return OcldiagramsPackage.MESSAGE_EXP__TARGET;
                case ExpressionsPackage.MESSAGE_EXP__ARGUMENT:
                    return OcldiagramsPackage.MESSAGE_EXP__ARGUMENT;
                case ExpressionsPackage.MESSAGE_EXP__CALLED_OPERATION:
                    return OcldiagramsPackage.MESSAGE_EXP__CALLED_OPERATION;
                case ExpressionsPackage.MESSAGE_EXP__SENT_SIGNAL:
                    return OcldiagramsPackage.MESSAGE_EXP__SENT_SIGNAL;
                default:
                    return -1;
            }
        }
