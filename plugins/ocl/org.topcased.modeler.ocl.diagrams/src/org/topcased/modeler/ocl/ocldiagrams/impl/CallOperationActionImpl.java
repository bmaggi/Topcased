 ...
 * </copyright>
 *
 * $Id: CallOperationActionImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CallOperationActionImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class CallOperationActionImpl extends EObjectImpl implements CallOperationAction
{
    ...
    {
        return OcldiagramsPackage.Literals.CALL_OPERATION_ACTION;
    }
        ...
        if (operation != null && operation.eIsProxy())
        {
            ...
            if (operation != oldOperation)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiagramsPackage.CALL_OPERATION_ACTION__OPERATION, oldOperation, operation));
            }
        }
        return operation;
    }
    ...
    public void setOperation(EOperation newOperation)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.CALL_OPERATION_ACTION__OPERATION, oldOperation, operation));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.CALL_OPERATION_ACTION__OPERATION:
                if (resolve)
                    return getOperation();
