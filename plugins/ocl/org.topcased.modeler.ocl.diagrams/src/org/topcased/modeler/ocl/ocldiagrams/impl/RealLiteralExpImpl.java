 ...
 * </copyright>
 *
 * $Id: RealLiteralExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.RealLiteralExpImpl#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class RealLiteralExpImpl extends NumericLiteralExpImpl implements RealLiteralExp
{
    ...
    {
        return OcldiagramsPackage.Literals.REAL_LITERAL_EXP;
    }
    ...
    public void setRealSymbol(Double newRealSymbol)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.REAL_LITERAL_EXP__REAL_SYMBOL, oldRealSymbol, realSymbol));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.REAL_LITERAL_EXP__REAL_SYMBOL:
        ...
        if (baseClass == org.eclipse.ocl.expressions.RealLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.REAL_LITERAL_EXP__REAL_SYMBOL:
                    return OcldiagramsPackage.REAL_LITERAL_EXP__REAL_SYMBOL;
                default:
                    return -1;
            }
        }
