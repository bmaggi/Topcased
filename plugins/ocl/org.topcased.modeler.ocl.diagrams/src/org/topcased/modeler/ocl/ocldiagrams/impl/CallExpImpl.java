 ...
 * </copyright>
 *
 * $Id: CallExpImpl.java,v 1.2 2009/04/20 08:07:07 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CallExpImpl#getPropertyStartPosition <em>Property Start Position
 * </em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CallExpImpl#getPropertyEndPosition <em>Property End Position
 * </em>}</li>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.CallExpImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class CallExpImpl extends OCLExpressionImpl implements CallExp
{
    ...
    {
        return OcldiagramsPackage.Literals.CALL_EXP;
    }
    ...
    public void setPropertyStartPosition(int newPropertyStartPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.CALL_EXP__PROPERTY_START_POSITION, oldPropertyStartPosition, propertyStartPosition));
    }
    ...
    public void setPropertyEndPosition(int newPropertyEndPosition)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.CALL_EXP__PROPERTY_END_POSITION, oldPropertyEndPosition, propertyEndPosition));
    }
    ...
    public NotificationChain basicSetSource(OCLExpression<BusinessType> newSource, NotificationChain msgs)
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.CALL_EXP__SOURCE, oldSource, newSource);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSource(OCLExpression<BusinessType> newSource)
    {
        if (newSource != source)
        {
            ...
            if (source != null)
                msgs = ((InternalEObject) source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.CALL_EXP__SOURCE, null, msgs);
            if (newSource != null)
                msgs = ((InternalEObject) newSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OcldiagramsPackage.CALL_EXP__SOURCE, null, msgs);
            msgs = basicSetSource(newSource, msgs);
            if (msgs != null)
                msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.CALL_EXP__SOURCE, newSource, newSource));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.CALL_EXP__SOURCE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.CALL_EXP__PROPERTY_START_POSITION:
                return new Integer(getPropertyStartPosition());
            case OcldiagramsPackage.CALL_EXP__PROPERTY_END_POSITION:
        ...
        if (baseClass == CallingASTNode.class)
        {
            switch (baseFeatureID)
            {
                case UtilitiesPackage.CALLING_AST_NODE__PROPERTY_START_POSITION:
                    return OcldiagramsPackage.CALL_EXP__PROPERTY_START_POSITION;
                case UtilitiesPackage.CALLING_AST_NODE__PROPERTY_END_POSITION:
                    return OcldiagramsPackage.CALL_EXP__PROPERTY_END_POSITION;
                default:
                    return -1;
            }
        }
        if (baseClass == org.eclipse.ocl.expressions.CallExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.CALL_EXP__SOURCE:
                    return OcldiagramsPackage.CALL_EXP__SOURCE;
                default:
                    return -1;
            }
        }
