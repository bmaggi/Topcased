 ...
 * </copyright>
 *
 * $Id: TupleLiteralExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.TupleLiteralExpImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TupleLiteralExpImpl extends LiteralExpImpl implements TupleLiteralExp
{
    ...
    {
        return OcldiagramsPackage.Literals.TUPLE_LITERAL_EXP;
    }
    ...
    public EList<TupleLiteralPart<BusinessType, EStructuralFeature>> getPart()
    {
        if (part == null)
        {
            part = new EObjectContainmentEList<TupleLiteralPart<BusinessType, EStructuralFeature>>(TupleLiteralPart.class, this, OcldiagramsPackage.TUPLE_LITERAL_EXP__PART);
        }
        return part;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.TUPLE_LITERAL_EXP__PART:
        ...
        if (baseClass == org.eclipse.ocl.expressions.TupleLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.TUPLE_LITERAL_EXP__PART:
                    return OcldiagramsPackage.TUPLE_LITERAL_EXP__PART;
                default:
                    return -1;
            }
        }
