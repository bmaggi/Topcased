 ...
 * </copyright>
 *
 * $Id: BooleanLiteralExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.BooleanLiteralExpImpl#getBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class BooleanLiteralExpImpl extends PrimitiveLiteralExpImpl implements BooleanLiteralExp
{
    ...
    {
        return OcldiagramsPackage.Literals.BOOLEAN_LITERAL_EXP;
    }
    ...
    public void setBooleanSymbol(Boolean newBooleanSymbol)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.BOOLEAN_LITERAL_EXP__BOOLEAN_SYMBOL, oldBooleanSymbol, booleanSymbol));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.BOOLEAN_LITERAL_EXP__BOOLEAN_SYMBOL:
        ...
        if (baseClass == org.eclipse.ocl.expressions.BooleanLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.BOOLEAN_LITERAL_EXP__BOOLEAN_SYMBOL:
                    return OcldiagramsPackage.BOOLEAN_LITERAL_EXP__BOOLEAN_SYMBOL;
                default:
                    return -1;
            }
        }
