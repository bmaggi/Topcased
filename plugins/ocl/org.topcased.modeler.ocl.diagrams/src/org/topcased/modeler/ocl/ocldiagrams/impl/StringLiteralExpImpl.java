 ...
 * </copyright>
 *
 * $Id: StringLiteralExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.StringLiteralExpImpl#getStringSymbol <em>String Symbol</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class StringLiteralExpImpl extends PrimitiveLiteralExpImpl implements StringLiteralExp
{
    ...
    {
        return OcldiagramsPackage.Literals.STRING_LITERAL_EXP;
    }
    ...
    public void setStringSymbol(String newStringSymbol)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.STRING_LITERAL_EXP__STRING_SYMBOL, oldStringSymbol, stringSymbol));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.STRING_LITERAL_EXP__STRING_SYMBOL:
        ...
        if (baseClass == org.eclipse.ocl.expressions.StringLiteralExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.STRING_LITERAL_EXP__STRING_SYMBOL:
                    return OcldiagramsPackage.STRING_LITERAL_EXP__STRING_SYMBOL;
                default:
                    return -1;
            }
        }
