 ...
 * </copyright>
 *
 * $Id: VariableExpImpl.java,v 1.2 2009/04/20 08:07:08 sgabel Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.modeler.ocl.ocldiagrams.impl.VariableExpImpl#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class VariableExpImpl extends OCLExpressionImpl implements VariableExp
{
    ...
    {
        return OcldiagramsPackage.Literals.VARIABLE_EXP;
    }
        ...
        if (referredVariable != null && referredVariable.eIsProxy())
        {
            ...
            if (referredVariable != oldReferredVariable)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OcldiagramsPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
            }
        }
    ...
    public void setReferredVariable(Variable<BusinessType, EParameter> newReferredVariable)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OcldiagramsPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType)
    {
        switch (featureID)
        {
            case OcldiagramsPackage.VARIABLE_EXP__REFERRED_VARIABLE:
                if (resolve)
        ...
        if (baseClass == org.eclipse.ocl.expressions.VariableExp.class)
        {
            switch (baseFeatureID)
            {
                case ExpressionsPackage.VARIABLE_EXP__REFERRED_VARIABLE:
                    return OcldiagramsPackage.VARIABLE_EXP__REFERRED_VARIABLE;
                default:
                    return -1;
            }
        }
