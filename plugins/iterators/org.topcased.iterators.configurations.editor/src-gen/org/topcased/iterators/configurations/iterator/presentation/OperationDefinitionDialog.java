 ...
 * </copyright>
 *
 * $Id: OperationDefinitionDialog.java,v 1.1 2013/01/18 11:00:55 omelois Exp $
 */
 ...
 * </p>
 * <p>
 * This class is cloned from <code>org.eclipse.jface.dialogs.InputDialog</code>, with minimal changes required for extensibility. A bugzilla has been
 * filed to request a more flexible implementation. If it is fixed, this class will go away.
 * </p>
 */
public class OperationDefinitionDialog extends Dialog {
	 ...
	 */
	public OperationDefinitionDialog(Shell parentShell, String dialogTitle, String dialogMessage, String initialValue, IInputValidator validator) {
		super(parentShell);
	...
	protected Text createText(Composite composite) {
		...
		data.heightHint = 500 + 5 * text.getLineHeight();
		//= Display.getCurrent().getPrimaryMonitor().getClientArea().height - 200;

		data.widthHint = 800 + convertHorizontalDLUsToPixels(IDialogConstants.ENTRY_FIELD_WIDTH);
		//Display.getCurrent().getPrimaryMonitor().getClientArea().width - 200;
