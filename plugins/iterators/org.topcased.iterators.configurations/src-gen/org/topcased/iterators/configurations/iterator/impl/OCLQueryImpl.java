 ...
 * </copyright>
 *
 * $Id: OCLQueryImpl.java,v 1.1 2013/01/18 11:03:45 omelois Exp $
 */
 ...
 * <ul>
 * <li>{@link org.topcased.iterators.configurations.iterator.impl.OCLQueryImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class OCLQueryImpl extends QueryImpl implements OCLQuery {
	...
	protected EClass eStaticClass() {
		return IteratorPackage.Literals.OCL_QUERY;
	}
	...
	public void setBody(String newBody) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IteratorPackage.OCL_QUERY__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch(featureID) {
		case IteratorPackage.OCL_QUERY__BODY:
			return getBody();
		}
